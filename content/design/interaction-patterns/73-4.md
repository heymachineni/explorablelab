...
slug: "73-4"
title: "Sandbox × Rewiring (5)"
summary: "Sandbox × Rewiring (5): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, sandbox, rewiring]
scores:
  visual_potential: 6
...
**Interaction pattern:** Sandbox × Rewiring (5) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
