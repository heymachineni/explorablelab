...
slug: "drop"
title: "Documents"
summary: "Documents: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, documents]
scores:
  visual_potential: 8
...
**Interaction pattern:** Documents gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[abilene-paradox]] · [[barn-paradox]] · [[birthday-paradox]]
