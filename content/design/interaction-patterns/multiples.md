...
slug: "multiples"
title: "Adventure"
summary: "Adventure: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, adventure]
scores:
  visual_potential: 7
...
**Interaction pattern:** Adventure gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[concept-4-economics]] · [[confidence]] · [[consensus-2]]
