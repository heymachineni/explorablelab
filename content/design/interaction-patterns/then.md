...
slug: "then"
title: "Drag"
summary: "Drag: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, drag]
scores:
  visual_potential: 6
...
**Interaction pattern:** Drag gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
