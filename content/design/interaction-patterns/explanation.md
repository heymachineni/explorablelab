...
slug: "explanation"
title: "Tutorial"
summary: "Tutorial: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, tutorial]
scores:
  visual_potential: 8
...
**Interaction pattern:** Tutorial gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[tradeoff]] · [[transformers]] · [[transport-2]]
