...
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, tournament]
scores:
  visual_potential: 8
...
**Interaction pattern:** Tournament gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
