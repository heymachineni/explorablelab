...
slug: "by-2"
title: "Tangible"
summary: "Tangible: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, tangible]
scores:
  visual_potential: 8
...
**Interaction pattern:** Tangible gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
