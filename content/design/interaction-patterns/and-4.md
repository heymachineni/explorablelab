...
slug: "and-4"
title: "Reactive"
summary: "Reactive: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, reactive]
scores:
  visual_potential: 7
...
**Interaction pattern:** Reactive gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
