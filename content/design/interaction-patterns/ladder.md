...
slug: "ladder"
title: "Small"
summary: "Small: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, small]
scores:
  visual_potential: 8
...
**Interaction pattern:** Small gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
