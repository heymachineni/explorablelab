...
slug: "redo"
title: "Replay"
summary: "Replay: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, replay]
scores:
  visual_potential: 7
...
**Interaction pattern:** Replay gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
