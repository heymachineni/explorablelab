...
slug: "collaborative"
title: "Commit"
summary: "Commit: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, commit]
scores:
  visual_potential: 7
...
**Interaction pattern:** Commit gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
