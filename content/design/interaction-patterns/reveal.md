...
related:
  theories: [mental-2, mere, metapopulation]
---
...
**Interaction pattern:** And gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[paradox-125]] · [[paradox-131]] · [[paradox-138]]
