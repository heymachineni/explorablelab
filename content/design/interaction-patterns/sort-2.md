...
**Interaction pattern:** Editing gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[logical-paradox-138]] · [[logical-paradox-144]] · [[logical-paradox-150]]
