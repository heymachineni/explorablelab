...
slug: "voice"
title: "Voice"
summary: "Voice: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, voice]
scores:
  visual_potential: 7
...
**Interaction pattern:** Voice gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
