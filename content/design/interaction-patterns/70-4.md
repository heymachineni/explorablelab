...
slug: "70-4"
title: "Placement × View (2)"
summary: "Placement × View (2): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, placement, view]
scores:
  visual_potential: 6
...
**Interaction pattern:** Placement × View (2) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
