...
slug: "documents"
title: "Wizard"
summary: "Wizard: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, wizard]
scores:
  visual_potential: 8
...
**Interaction pattern:** Wizard gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
