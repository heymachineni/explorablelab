...
slug: "72-4"
title: "Slider × Graph (4)"
summary: "Slider × Graph (4): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, slider, graph]
scores:
  visual_potential: 6
...
**Interaction pattern:** Slider × Graph (4) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
