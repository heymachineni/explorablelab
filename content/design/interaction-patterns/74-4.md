...
slug: "74-4"
title: "Mode × Ladder (6)"
summary: "Mode × Ladder (6): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, mode, ladder]
scores:
  visual_potential: 6
...
**Interaction pattern:** Mode × Ladder (6) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
