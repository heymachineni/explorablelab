...
slug: "system-4"
title: "Timeline"
summary: "Timeline: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, timeline]
scores:
  visual_potential: 8
...
**Interaction pattern:** Timeline gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
