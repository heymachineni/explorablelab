...
slug: "57-5"
title: "Circle × Decision (5)"
summary: "Circle × Decision (5): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, circle, decision]
scores:
  visual_potential: 9
...
**Visual metaphor:** Circle × Decision (5) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
