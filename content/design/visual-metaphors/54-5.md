...
slug: "54-5"
title: "Grid × Treemap (2)"
summary: "Grid × Treemap (2): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, grid, treemap]
scores:
  visual_potential: 9
...
**Visual metaphor:** Grid × Treemap (2) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
