...
slug: "sandpile"
title: "Force"
summary: "Force: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, force]
scores:
  visual_potential: 9
...
**Visual metaphor:** Force gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
