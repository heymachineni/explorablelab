...
slug: "55-5"
title: "Feedback × Sankey (3)"
summary: "Feedback × Sankey (3): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, feedback, sankey]
scores:
  visual_potential: 9
...
**Visual metaphor:** Feedback × Sankey (3) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
