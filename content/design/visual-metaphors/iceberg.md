...
slug: "iceberg"
title: "Bridge"
summary: "Bridge: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, bridge]
scores:
  visual_potential: 9
...
**Visual metaphor:** Bridge gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[pygmalion-class]] · [[sandpile-avalanche]] · [[stag-hunt-woods]]
