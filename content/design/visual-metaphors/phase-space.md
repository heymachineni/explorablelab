...
**Visual metaphor:** Circle gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
...
- [[presentation]] · [[principal]] · [[principle-7]]
