...
slug: "neighborhood"
title: "Double"
summary: "Double: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, double]
scores:
  visual_potential: 9
...
**Visual metaphor:** Double gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
