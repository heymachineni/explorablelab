...
slug: "53-5"
title: "Neighborhood × Board (1)"
summary: "Neighborhood × Board (1): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, neighborhood, board]
scores:
  visual_potential: 9
...
**Visual metaphor:** Neighborhood × Board (1) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
