...
slug: "grid"
title: "Well Potential Network"
summary: "Well Potential Network: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, well, potential, network]
scores:
  visual_potential: 9
...
# Well Potential Network

## What it is

**Visual metaphor:** Well Potential Network gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
