...
slug: "diagram"
title: "Stream"
summary: "Stream: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, stream]
scores:
  visual_potential: 9
...
**Visual metaphor:** Stream gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
