...
slug: "99-3"
title: "Three Act Structure × Frame (4)"
summary: "Three Act Structure × Frame (4): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, three, act, structure, frame]
scores:
  visual_potential: 5
...
# Three Act Structure × Frame (4)

## What it is

**Story structure:** Three Act Structure × Frame (4) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
