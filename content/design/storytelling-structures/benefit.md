...
slug: "benefit"
title: "Challenge"
summary: "Challenge: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, challenge]
scores:
  visual_potential: 4
...
related:
  theories: [rate, rational, rational-2]
---
...
**Story structure:** Challenge gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
