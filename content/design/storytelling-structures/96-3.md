...
slug: "96-3"
title: "Heros × Res (1)"
summary: "Heros × Res (1): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, heros, res]
scores:
  visual_potential: 4
...
**Story structure:** Heros × Res (1) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
