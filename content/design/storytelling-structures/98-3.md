...
slug: "98-3"
title: "Monomyth × Open (3)"
summary: "Monomyth × Open (3): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, monomyth, open]
scores:
  visual_potential: 5
...
**Story structure:** Monomyth × Open (3) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
