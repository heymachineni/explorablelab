...
slug: "97-3"
title: "Journey × Cold (2)"
summary: "Journey × Cold (2): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, journey, cold]
scores:
  visual_potential: 5
...
**Story structure:** Journey × Cold (2) gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
