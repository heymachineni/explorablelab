...
slug: "start"
title: "Hope"
summary: "Hope: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, hope]
scores:
  visual_potential: 4
...
related:
  theories: [pluralistic, pluralistic-ignorance, points]
---
...
**Story structure:** Hope gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
