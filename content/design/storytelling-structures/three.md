...
slug: "three"
title: "Four"
summary: "Four: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, four]
scores:
  visual_potential: 5
...
**Story structure:** Four gives authors a reusable move when building explorables. It encodes *when* to use interaction, not just *what* to animate.
