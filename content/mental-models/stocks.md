...
slug: "stocks"
title: "Fence"
summary: "Fence: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, fence]
scores:
  visual_potential: 6
...
Fence is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where fence clarifies trade-offs
...
- [[logic-4]] — formal grounding
- [[low]] — formal grounding
...
- [ ] Pair with [[stocks-theory]] formal node
