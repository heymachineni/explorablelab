...
slug: "signals"
title: "Review"
summary: "Review: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, review]
scores:
  visual_potential: 5
...
Review is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where review clarifies trade-offs
...
- [ ] Pair with [[signals-theory]] formal node
