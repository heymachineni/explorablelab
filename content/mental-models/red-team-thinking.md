...
id: "MOD-0037"
type: "mental-model"
slug: "red-team-thinking"
title: "Lock"
summary: "Lock: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, lock]
scores:
  visual_potential: 6
...
Lock is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where lock clarifies trade-offs
...
- [[euler]] — formal grounding
- [[execution]] — formal grounding
...
- [ ] Pair with [[red-team-thinking-theory]] formal node

## See also

- [[euler]] · [[execution]] · [[externality]]
