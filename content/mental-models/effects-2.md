...
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, signaling]
scores:
  visual_potential: 6
...
Signaling is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where signaling clarifies trade-offs
...
- [[variance]] — formal grounding
- [[volterra]] — formal grounding
- [[weak]] — formal grounding
...
- [ ] Pair with [[effects-2-theory]] formal node
