...
slug: "steel-manning"
title: "Path"
summary: "Path: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, path]
scores:
  visual_potential: 6
...
Path is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where path clarifies trade-offs
...
- [ ] Pair with [[steel-manning-theory]] formal node

## See also

- [[exclusion]] · [[extended]] · [[fallacy-2]]
