...
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, inattentional]
scores:
  visual_potential: 6
...
related:
  theories: [correlated, cosmic, cost]
---
...
Inattentional is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where inattentional clarifies trade-offs
...
- [ ] Pair with [[asymmetry-2-theory]] formal node
