...
slug: "comparative-3"
title: "Red"
summary: "Red: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, red]
scores:
  visual_potential: 5
...
Red is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where red clarifies trade-offs
...
- [[conservation-3]] — formal grounding
...
- [ ] Pair with [[comparative-3-theory]] formal node
