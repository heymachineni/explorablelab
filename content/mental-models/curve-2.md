...
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, dissonance]
scores:
  visual_potential: 7
...
Dissonance is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where dissonance clarifies trade-offs
...
- [ ] Pair with [[curve-2-theory]] formal node

## See also

- [[marginal]] · [[matching]] · [[mechanics-3]]
