...
slug: "fence"
title: "Compromise"
summary: "Compromise: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, compromise]
scores:
  visual_potential: 6
...
Compromise is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where compromise clarifies trade-offs
...
- [[paradox-151]] — formal grounding
- [[paradox-158]] — formal grounding
...
- [ ] Pair with [[fence-theory]] formal node
