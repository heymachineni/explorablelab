...
slug: "ooda"
title: "Circle × Offs (7)"
summary: "Circle × Offs (7): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, circle, offs]
scores:
  visual_potential: 6
...
Circle × Offs (7) is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where circle × offs (7) clarifies trade-offs
...
- [ ] Pair with [[ooda-theory]] formal node

## See also

- [[byzantine]] · [[cap]] · [[capture]]
