...
Nudge is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where nudge clarifies trade-offs
...
- [[paradox-178]] — formal grounding
- [[paradox-184]] — formal grounding
- [[paradox-190]] — formal grounding
...
- [ ] Pair with [[hanlons-theory]] formal node
