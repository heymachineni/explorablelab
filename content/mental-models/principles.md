...
slug: "principles"
title: "Principal"
summary: "Principal: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, principal]
scores:
  visual_potential: 7
...
related:
  theories: [transport-3, trees, triadic]
---
...
Principal is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where principal clarifies trade-offs
...
- [ ] Pair with [[principles-theory]] formal node
