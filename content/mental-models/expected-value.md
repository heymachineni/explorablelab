...
Critical is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where critical clarifies trade-offs
...
- [[flows]] — formal grounding
- [[force]] — formal grounding
...
- [ ] Pair with [[expected-value-theory]] formal node
