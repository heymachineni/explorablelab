...
slug: "diffusion-3"
title: "Halo"
summary: "Halo: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, halo]
scores:
  visual_potential: 7
...
Halo is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where halo clarifies trade-offs
...
- [ ] Pair with [[diffusion-3-theory]] formal node
