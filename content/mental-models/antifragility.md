...
slug: "antifragility"
title: "Switching"
summary: "Switching: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, switching]
scores:
  visual_potential: 6
...
Switching is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where switching clarifies trade-offs
...
- [[fitts]] — formal grounding
- [[folk]] — formal grounding
...
- [ ] Pair with [[antifragility-theory]] formal node
