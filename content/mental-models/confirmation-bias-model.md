...
related:
  theories: [comparative-2, comparative-advantage, competitive]
---
...
Demand is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where demand clarifies trade-offs
...
- [ ] Pair with [[confirmation-bias-model-theory]] formal node
