...
related:
  theories: [hypothesis-2, hypothesis-3, hypothesis-4]
---
...
Framing is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where framing clarifies trade-offs
...
- [[logical-paradox-118]] — formal grounding
...
- [ ] Pair with [[blue-theory]] formal node

## See also

- [[logical-paradox-118]] · [[logical-paradox-124]] · [[logical-paradox-130]]
