...
slug: "occams-razor"
title: "Territory"
summary: "Territory: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, territory]
scores:
  visual_potential: 7
...
Territory is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where territory clarifies trade-offs
...
- [ ] Pair with [[occams-razor-theory]] formal node
