...
slug: "transitions-2"
title: "Loop"
summary: "Loop: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [complex-systems, loop]
scores:
  visual_potential: 7
...
Loop is a compact cognitive tool for deciding under uncertainty. It is not a law of nature—it is a **lens** that highlights some variables and hides others.

## When to use

- Facing a complex decision where loop clarifies trade-offs
...
- [[38-paradox]] — formal grounding
- [[44-paradox]] — formal grounding
...
- [ ] Pair with [[transitions-2-theory]] formal node
