...
slug: "asian"
title: "Asian"
summary: "Asian: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, asian]
scores:
  visual_potential: 7
...
related:
  theories: [loss, loss-aversion, lotka]
---
...
What happens to human judgment, behavior, or perception when asian conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of asian is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[asian-phenomenon]] — observable outcome node

## See also

- [[action-3]] · [[adverse]] · [[algorithms]]
