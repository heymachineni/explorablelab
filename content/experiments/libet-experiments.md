...
updated: "2026-06-26"
confidence: "medium"
tags: [neuroscience-discipline, cognitive]
scores:
  visual_potential: 8
...
What happens to human judgment, behavior, or perception when cognitive conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of cognitive is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[libet-experiments-phenomenon]] — observable outcome node

## See also

- [[priority]] · [[problem-6]] · [[programming-2]]
