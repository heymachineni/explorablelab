...
What happens to human judgment, behavior, or perception when blindness conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of blindness is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[asch-phenomenon]] — observable outcome node
