...
related:
  theories: [jevons-fireplace, kelly-bet, kingman-queue]
---
...
What happens to human judgment, behavior, or perception when anchoring conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of anchoring is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[anchoring-3-phenomenon]] — observable outcome node

## See also

- [[stroop]] · [[superconductivity]] · [[synaptic]]
