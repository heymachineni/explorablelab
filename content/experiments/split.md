...
What happens to human judgment, behavior, or perception when split conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of split is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[split-phenomenon]] — observable outcome node
