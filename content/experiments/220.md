...
type: "experiment"
slug: "220"
title: "Factorial × 8 (81)"
summary: "Factorial × 8 (81): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
What happens to human judgment, behavior, or perception when factorial × 8 (81) conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of factorial × 8 (81) is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[220-phenomenon]] — observable outcome node

## See also

- [[familiarity]] · [[field-2]] · [[fitts]]
