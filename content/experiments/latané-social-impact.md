...
related:
  theories: [veil-room, vickrey-auction, war-of-attrition-clock]
---
...
What happens to human judgment, behavior, or perception when change conditions are manipulated? The study tests whether folk psychology matches measured outcomes.
...
Effect sizes vary by replication era, but the signature finding of change is robust enough to appear in introductory texts: people systematically deviate from normative models.
...
- [ ] [[latané-social-impact-phenomenon]] — observable outcome node
