...
summary: "Evidential Decision Theory: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [modern, modern-2, modernization]
---
...
Evidential Decision Theory presents a conflict between two compelling lines of reasoning. At least one common intuition must be abandoned—but which one?
...
### Missing pages
- [ ] [[logical-paradox-sim]] — interactive recreation spec

### Potential simulations
- **Evidential Decision Theory Lab** — interactive-game — priority: 9.0
