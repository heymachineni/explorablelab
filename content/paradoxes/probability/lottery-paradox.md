...
summary: "Preface Paradox: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, preface, paradox]
scores:
  visual_potential: 9
...
Preface Paradox presents a conflict between two compelling lines of reasoning. At least one common intuition must be abandoned—but which one?
...
### Missing pages
- [ ] [[lottery-paradox-sim]] — interactive recreation spec

### Potential simulations
- **Preface Paradox Lab** — interactive-game — priority: 9.0

## See also

- [[robustness]] · [[scarcity]] · [[seeking]]
