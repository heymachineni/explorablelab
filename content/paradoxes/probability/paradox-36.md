...
related:
  theories: [concept-14-social-science, concept-15-evolution, concept-16-probability]
---
...
Tragedy presents a conflict between two compelling lines of reasoning. At least one common intuition must be abandoned—but which one?
...
### Missing pages
- [ ] [[paradox-36-sim]] — interactive recreation spec

### Potential simulations
- **Tragedy Lab** — interactive-game — priority: 9.0
