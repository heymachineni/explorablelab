...
summary: "Ladder Paradox: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [philosophy, ladder, paradox]
scores:
  visual_potential: 9
...
Ladder Paradox presents a conflict between two compelling lines of reasoning. At least one common intuition must be abandoned—but which one?
...
### Missing pages
- [ ] [[paradox-38-sim]] — interactive recreation spec

### Potential simulations
- **Ladder Paradox Lab** — interactive-game — priority: 9.0

## See also

- [[hold]] · [[homotopy]] · [[hypothesis]]
