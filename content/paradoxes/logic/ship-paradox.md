...
Dark presents a conflict between two compelling lines of reasoning. At least one common intuition must be abandoned—but which one?
...
### Missing pages
- [ ] [[ship-paradox-sim]] — interactive recreation spec

### Potential simulations
- **Dark Lab** — interactive-game — priority: 9.0
