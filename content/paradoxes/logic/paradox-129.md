...
type: "paradox"
slug: "paradox-129"
title: "Curry Paradox × Spurious Correlation (6)"
summary: "Curry Paradox × Spurious Correlation (6): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [philosophy, curry, paradox, spurious, correlation]
scores:
  visual_potential: 7
...
# Curry Paradox × Spurious Correlation (6)

## Statement

Curry Paradox × Spurious Correlation (6) presents a conflict between two compelling lines of reasoning. At least one common intuition must be abandoned—but which one?
...
### Missing pages
- [ ] [[paradox-129-sim]] — interactive recreation spec

### Potential simulations
- **Curry Paradox × Spurious Correlation (6) Lab** — interactive-game — priority: 9.0

## See also

- [[logical-paradox-136]] · [[logical-paradox-142]] · [[logical-paradox-149]]
