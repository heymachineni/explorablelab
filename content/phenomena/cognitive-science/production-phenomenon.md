...
Pessimism Bias names a stable regularity in cognitive science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in pessimism bias |
...
- [ ] [[production-phenomenon-experiment]] — classic replication
