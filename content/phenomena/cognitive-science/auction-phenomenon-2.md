...
related:
  theories: [cautious, cell, cellular]
---
...
Norm names a stable regularity in cognitive science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in norm |
...
- [ ] [[auction-phenomenon-2-experiment]] — classic replication
