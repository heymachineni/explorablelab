...
Optimism Bias names a stable regularity in cognitive science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in optimism bias |
...
- [ ] [[second-phenomenon-experiment]] — classic replication

## See also

- [[logical-paradox-105]] · [[logical-paradox-111]] · [[logical-paradox-118]]
