...
related:
  theories: [antifragility-2, apophenia, aposematism]
---
...
Polarization names a stable regularity in cognitive science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in polarization |
...
- [ ] [[phenomena-phenomenon-experiment]] — classic replication
