...
updated: "2026-06-26"
confidence: "medium"
tags: [economics, gap, planning, fallacy]
scores:
  visual_potential: 9
...
Gap Planning Fallacy names a stable regularity in economics. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in gap planning fallacy |
...
- [ ] [[angular-phenomenon-experiment]] — classic replication

## See also

- [[logical-paradox-199]] · [[logical-paradox-25]] · [[logical-paradox-31]]
