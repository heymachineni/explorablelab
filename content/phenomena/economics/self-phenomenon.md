...
updated: "2026-06-26"
confidence: "medium"
tags: [economics, continued, influence, effect]
scores:
  visual_potential: 8
...
Continued Influence Effect names a stable regularity in economics. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in continued influence effect |
...
- [ ] [[self-phenomenon-experiment]] — classic replication
