...
Error names a stable regularity in economics. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in error |
...
- [ ] [[effect-phenomenon-13-experiment]] — classic replication
