...
Status Quo Bias names a stable regularity in ecology. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in status quo bias |
...
- [ ] [[duration-phenomenon-experiment]] — classic replication
