...
Decoy Effect names a stable regularity in ecology. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in decoy effect |
...
- [ ] [[theory-phenomenon-2-experiment]] — classic replication

## See also

- [[bias-6]] · [[biology]] · [[blindness]]
