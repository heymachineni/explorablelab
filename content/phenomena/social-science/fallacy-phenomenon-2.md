...
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, illusory, truth, effect]
scores:
  visual_potential: 9
...
Illusory Truth Effect names a stable regularity in social science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in illusory truth effect |
...
- [ ] [[fallacy-phenomenon-2-experiment]] — classic replication

## See also

- [[model]] · [[modern]] · [[monetarism]]
