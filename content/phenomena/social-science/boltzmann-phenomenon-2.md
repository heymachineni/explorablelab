...
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, proof, bandwagon, effect]
scores:
  visual_potential: 7
...
Proof Bandwagon Effect names a stable regularity in social science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in proof bandwagon effect |
...
- [ ] [[boltzmann-phenomenon-2-experiment]] — classic replication
