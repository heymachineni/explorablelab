...
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, consistency, authority, bias]
scores:
  visual_potential: 7
...
Consistency Authority Bias names a stable regularity in social science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in consistency authority bias |
...
- [ ] [[comparative-phenomenon-experiment]] — classic replication
