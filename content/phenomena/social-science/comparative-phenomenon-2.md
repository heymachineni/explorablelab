...
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, scarcity, effect]
scores:
  visual_potential: 9
...
Scarcity Effect names a stable regularity in social science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in scarcity effect |
...
- [ ] [[comparative-phenomenon-2-experiment]] — classic replication
