...
Diffusion names a stable regularity in social science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in diffusion |
...
- [ ] [[quantum-phenomenon-2-experiment]] — classic replication

## See also

- [[scholes]] · [[selection-3]] · [[self]]
