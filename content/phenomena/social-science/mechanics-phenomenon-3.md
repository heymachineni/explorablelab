...
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, bias, out, group]
scores:
  visual_potential: 8
...
related:
  theories: [laws, learning, learning-2]
---
...
Bias Out Group names a stable regularity in social science. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in bias out group |
...
- [ ] [[mechanics-phenomenon-3-experiment]] — classic replication

## See also

- [[doomsday-argument]] · [[ellsberg-paradox-2]] · [[fallacy-paradox]]
