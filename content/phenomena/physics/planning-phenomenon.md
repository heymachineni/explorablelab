...
updated: "2026-06-26"
confidence: "medium"
tags: [physics, serial, position, effect]
scores:
  visual_potential: 9
...
Serial Position Effect names a stable regularity in physics. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in serial position effect |
...
- [ ] [[planning-phenomenon-experiment]] — classic replication
