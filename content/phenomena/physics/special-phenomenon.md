...
Homogeneity names a stable regularity in physics. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in homogeneity |
...
- [ ] [[special-phenomenon-experiment]] — classic replication
