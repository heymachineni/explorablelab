...
updated: "2026-06-26"
confidence: "medium"
tags: [history-of-science-discipline, stroop, effect]
scores:
  visual_potential: 8
  ...
  composite: 7.5
fields: [history-of-science-discipline]
...
Stroop Effect names a stable regularity in history of science discipline. It is phenomenological: we see it before we fully agree on mechanism.
...
| Theory | Prediction |
|--------|------------|
| Primary account | Explains main effect in stroop effect |
...
- [ ] [[scientific-revolutions-experiment]] — classic replication
