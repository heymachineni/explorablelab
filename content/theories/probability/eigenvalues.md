...
slug: "eigenvalues"
title: "Eigenvalues"
summary: "Eigenvalues: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, eigenvalues]
scores:
  visual_potential: 8
...
> **One-line essence:** Eigenvalues links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Eigenvalues sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in eigenvalues | field-specific |
...
Reading about eigenvalues invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip eigenvalues from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under eigenvalues dynamics.
...
- **Education:** teach eigenvalues with sandbox labs before equations.
...
- [[sleeping-paradox]] · [[stag-paradox]] · [[time-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[eigenvalues-paper]] — canonical citation anchor

### Potential simulations
- **Eigenvalues Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[sleeping-paradox]] — structural analogy
- [[stag-paradox]] — structural analogy
