...
slug: "fermat"
title: "Stability"
summary: "Stability: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, stability]
scores:
  visual_potential: 7
...
related:
  theories: [foot, for, force]
---

# Stability

> **One-line essence:** Stability is a core framework for reasoning about mathematics and probability.

## Why this matters

Without grasping stability, practitioners in mathematics and probability overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Stability formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in stability. Under standard assumptions in mathematics and probability, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing stability.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in stability | field-specific |
...
Reading about stability invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip stability from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under stability dynamics.
...
- **Education:** teach stability with sandbox labs before equations.
...
- [[ellsberg-urn]] · [[fermi-silence]] · [[gestalt-spin]]

## Discovery suggestions

### Missing pages to create
- [ ] [[fermat-paper]] — canonical citation anchor

### Potential simulations
- **Stability Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[ellsberg-urn]] — structural analogy
- [[fermi-silence]] — structural analogy
