...
slug: "homotopy"
title: "Zfc"
summary: "Zfc: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, zfc]
scores:
  visual_potential: 7
...
> **One-line essence:** Zfc links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Zfc sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in zfc | field-specific |
...
Reading about zfc invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip zfc from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under zfc dynamics.
...
- **Education:** teach zfc with sandbox labs before equations.
...
- [ ] [[homotopy-paper]] — canonical citation anchor

### Potential simulations
- **Zfc Sandbox** — web-simulation — priority: high
