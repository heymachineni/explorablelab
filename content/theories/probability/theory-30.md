...
summary: "Linear Programming: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, linear, programming]
scores:
  visual_potential: 6
...
> **One-line essence:** Linear Programming links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Linear Programming sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in linear programming | field-specific |
...
Reading about linear programming invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip linear programming from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under linear programming dynamics.
...
- **Education:** teach linear programming with sandbox labs before equations.
...
- [[nonlocality-paradox]] · [[paradox-101]] · [[paradox-108]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theory-30-paper]] — canonical citation anchor

### Potential simulations
- **Linear Programming Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[nonlocality-paradox]] — structural analogy
- [[paradox-101]] — structural analogy
