...
type: "theory"
slug: "theory-36"
title: "Calculus × Value (1)"
summary: "Calculus × Value (1): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, calculus, value]
scores:
  visual_potential: 8
...
> **One-line essence:** Calculus × Value (1) links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Calculus × Value (1) sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in calculus × value (1) | field-specific |
...
Reading about calculus × value (1) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip calculus × value (1) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under calculus × value (1) dynamics.
...
- **Education:** teach calculus × value (1) with sandbox labs before equations.
...
- [[paradox-158]] · [[paradox-164]] · [[paradox-170]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theory-36-paper]] — canonical citation anchor

### Potential simulations
- **Calculus × Value (1) Sandbox** — web-simulation — priority: high
