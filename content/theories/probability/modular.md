...
slug: "modular"
title: "Lagrange"
summary: "Lagrange: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, lagrange]
scores:
  visual_potential: 7
...
related:
  theories: [satterthwaite, scale, scale-2]
---

# Lagrange

> **One-line essence:** Lagrange explains how local rules produce global patterns in mathematics and probability.

## Why this matters

Policymakers, educators, and designers misapply lagrange when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, lagrange describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in lagrange. Under standard assumptions in mathematics and probability, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing lagrange.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in lagrange | field-specific |
...
Reading about lagrange invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip lagrange from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under lagrange dynamics.
...
- **Education:** teach lagrange with sandbox labs before equations.
...
- [[moravecs-paradox]] · [[of-paradox-2]] · [[paradox-103]]

## Discovery suggestions

### Missing pages to create
- [ ] [[modular-paper]] — canonical citation anchor

### Potential simulations
- **Lagrange Sandbox** — web-simulation — priority: high
