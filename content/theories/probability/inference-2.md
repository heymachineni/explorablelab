...
slug: "inference-2"
title: "Forms"
summary: "Forms: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, forms]
scores:
  visual_potential: 7
...
related:
  theories: [cognition, cognition-2, cognition-3]
---

# Forms

> **One-line essence:** Forms links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Forms sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in forms | field-specific |
...
Reading about forms invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip forms from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under forms dynamics.
...
- **Education:** teach forms with sandbox labs before equations.
...
- [[impossibility]] · [[inattentional]]

## Discovery suggestions

### Missing pages to create
- [ ] [[inference-2-paper]] — canonical citation anchor

### Potential simulations
- **Forms Sandbox** — web-simulation — priority: high
