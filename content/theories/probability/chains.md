...
slug: "chains"
title: "Problems"
summary: "Problems: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, problems]
scores:
  visual_potential: 7
...
related:
  theories: [information-cascade-falls, institutional-ratchet, island-biogeography]
---

# Problems

> **One-line essence:** Problems is a core framework for reasoning about mathematics and probability.

## Why this matters

Without grasping problems, practitioners in mathematics and probability overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Problems formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.
...
2. Specify update rules or conservation laws governing problems.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in problems | field-specific |
...
Reading about problems invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip problems from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under problems dynamics.
...
- **Education:** teach problems with sandbox labs before equations.
...
- [[logical-paradox-102]] · [[logical-paradox-109]] · [[logical-paradox-115]]

## Discovery suggestions

### Missing pages to create
- [ ] [[chains-paper]] — canonical citation anchor

### Potential simulations
- **Problems Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[logical-paradox-102]] — structural analogy
- [[logical-paradox-109]] — structural analogy
