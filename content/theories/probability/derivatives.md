...
slug: "derivatives"
title: "Linear"
summary: "Linear: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, linear]
scores:
  visual_potential: 7
...
related:
  theories: [graph, graph-2, graphs]
---

# Linear

> **One-line essence:** Linear links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Linear sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in linear | field-specific |
...
Reading about linear invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip linear from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under linear dynamics.
...
- **Education:** teach linear with sandbox labs before equations.
...
- [ ] [[derivatives-paper]] — canonical citation anchor

### Potential simulations
- **Linear Sandbox** — web-simulation — priority: high
