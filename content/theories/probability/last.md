...
slug: "last"
title: "Lyapunov"
summary: "Lyapunov: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, lyapunov]
scores:
  visual_potential: 7
...
> **One-line essence:** Lyapunov links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Lyapunov sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in lyapunov | field-specific |
...
Reading about lyapunov invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip lyapunov from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under lyapunov dynamics.
...
- **Education:** teach lyapunov with sandbox labs before equations.
...
- [ ] [[last-paper]] — canonical citation anchor

### Potential simulations
- **Lyapunov Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[particle-2]] — structural analogy
- [[percolation-2]] — structural analogy
