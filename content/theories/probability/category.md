...
updated: "2026-06-26"
confidence: "medium"
tags: [probability, social, choice, theory]
scores:
  visual_potential: 7
...
related:
  theories: [control-2, convex, convolutional]
---

# Social Choice Theory

> **One-line essence:** Social Choice Theory explains how local rules produce global patterns in mathematics and probability.

## Why this matters

Policymakers, educators, and designers misapply social choice theory when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, social choice theory describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in social choice theory. Under standard assumptions in mathematics and probability, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [[198-paradox]] · [[25-paradox]] · [[31-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[category-paper]] — canonical citation anchor

### Potential simulations
- **Social Choice Theory Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[198-paradox]] — structural analogy
- [[25-paradox]] — structural analogy
