...
slug: "flows"
title: "Propositional"
summary: "Propositional: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, propositional]
scores:
  visual_potential: 8
...
> **One-line essence:** Propositional links mechanism, prediction, and intervention in mathematics and probability.

## Why this matters

Propositional sits at the fault line between intuition and evidence in mathematics and probability; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in propositional | field-specific |
...
Reading about propositional invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip propositional from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under propositional dynamics.
...
- **Education:** teach propositional with sandbox labs before equations.
...
- [[opportunity]] · [[option]] · [[ostrom]]

## Discovery suggestions

### Missing pages to create
- [ ] [[flows-paper]] — canonical citation anchor

### Potential simulations
- **Propositional Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[opportunity]] — structural analogy
- [[option]] — structural analogy
