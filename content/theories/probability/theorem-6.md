...
slug: "theorem-6"
title: "Eigenvectors"
summary: "Eigenvectors: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [probability, eigenvectors]
scores:
  visual_potential: 8
...
related:
  theories: [apophenia, aposematism, arbitrage]
---

# Eigenvectors

> **One-line essence:** Eigenvectors explains how local rules produce global patterns in mathematics and probability.

## Why this matters

Policymakers, educators, and designers misapply eigenvectors when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, eigenvectors describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in eigenvectors. Under standard assumptions in mathematics and probability, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing eigenvectors.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in eigenvectors | field-specific |
...
Reading about eigenvectors invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip eigenvectors from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under eigenvectors dynamics.
...
- **Education:** teach eigenvectors with sandbox labs before equations.
...
- [[night-paradox]] · [[paradox-100]] · [[paradox-107]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theorem-6-paper]] — canonical citation anchor

### Potential simulations
- **Eigenvectors Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[night-paradox]] — structural analogy
- [[paradox-100]] — structural analogy
