...
type: "theory"
slug: "theory-9"
title: "Conservation × First Law (5)"
summary: "Conservation × First Law (5): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, conservation, first, law]
scores:
  visual_potential: 7
...
# Conservation × First Law (5)

> **One-line essence:** Conservation × First Law (5) links mechanism, prediction, and intervention in physics.

## Why this matters

Conservation × First Law (5) sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in conservation × first law (5) | field-specific |
...
Reading about conservation × first law (5) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip conservation × first law (5) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under conservation × first law (5) dynamics.
...
- **Education:** teach conservation × first law (5) with sandbox labs before equations.
...
- [[ergodicity]] · [[evolutionary-2]] · [[exponents]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theory-9-paper]] — canonical citation anchor

### Potential simulations
- **Conservation × First Law (5) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[ergodicity]] — structural analogy
- [[evolutionary-2]] — structural analogy
