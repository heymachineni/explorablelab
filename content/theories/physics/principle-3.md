...
slug: "principle-3"
title: "Conservation"
summary: "Conservation: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, conservation]
scores:
  visual_potential: 8
...
> **One-line essence:** Conservation is a core framework for reasoning about physics.

## Why this matters

Without grasping conservation, practitioners in physics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Conservation formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.
...
2. Specify update rules or conservation laws governing conservation.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in conservation | field-specific |
...
Reading about conservation invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip conservation from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under conservation dynamics.
...
- **Education:** teach conservation with sandbox labs before equations.
...
- [[loss]] · [[macroeconomics]] · [[market-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[principle-3-paper]] — canonical citation anchor

### Potential simulations
- **Conservation Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[loss]] — structural analogy
- [[macroeconomics]] — structural analogy
