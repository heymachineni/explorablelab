...
summary: "Thermodynamics: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Thermodynamics links mechanism, prediction, and intervention in physics.

## Why this matters

Thermodynamics sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in thermodynamics | field-specific |
...
Reading about thermodynamics invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip thermodynamics from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under thermodynamics dynamics.
...
- **Education:** teach thermodynamics with sandbox labs before equations.
...
- [[153-paradox]] · [[16-paradox]] · [[166-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[particle-paper]] — canonical citation anchor

### Potential simulations
- **Thermodynamics Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[153-paradox]] — structural analogy
