...
slug: "uncertainty"
title: "Curvature"
summary: "Curvature: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, curvature]
scores:
  visual_potential: 6
...
> **One-line essence:** Curvature links mechanism, prediction, and intervention in physics.

## Why this matters

Curvature sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in curvature. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing curvature.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in curvature | field-specific |
...
Reading about curvature invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip curvature from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under curvature dynamics.
...
- **Education:** teach curvature with sandbox labs before equations.
...
- [[paradox-78]] · [[paradox-84]] · [[paradox-90]]

## Discovery suggestions

### Missing pages to create
- [ ] [[uncertainty-paper]] — canonical citation anchor

### Potential simulations
- **Curvature Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-78]] — structural analogy
