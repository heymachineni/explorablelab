...
slug: "maxwell-2"
title: "Geometry"
summary: "Geometry: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Geometry explains how local rules produce global patterns in physics.

## Why this matters

Policymakers, educators, and designers misapply geometry when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, geometry describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in geometry. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing geometry.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in geometry | field-specific |
...
Reading about geometry invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip geometry from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under geometry dynamics.
...
- **Education:** teach geometry with sandbox labs before equations.
...
- [[auction]] · [[axioms]] · [[basic]]

## Discovery suggestions

### Missing pages to create
- [ ] [[maxwell-2-paper]] — canonical citation anchor

### Potential simulations
- **Geometry Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[auction]] — structural analogy
- [[axioms]] — structural analogy
