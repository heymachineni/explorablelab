...
slug: "superposition"
title: "Spacetime"
summary: "Spacetime: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [risky, rna, robustness]
---

# Spacetime

> **One-line essence:** Spacetime links mechanism, prediction, and intervention in physics.

## Why this matters

Spacetime sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in spacetime. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing spacetime.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in spacetime | field-specific |
...
Reading about spacetime invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip spacetime from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under spacetime dynamics.
...
- **Education:** teach spacetime with sandbox labs before equations.
...
- [[selection-8]] · [[serial]] · [[shift-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[superposition-paper]] — canonical citation anchor

### Potential simulations
- **Spacetime Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[selection-8]] — structural analogy
