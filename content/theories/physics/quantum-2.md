...
> **One-line essence:** Radiation explains how local rules produce global patterns in physics.

## Why this matters

Policymakers, educators, and designers misapply radiation when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, radiation describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in radiation. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [[theory-44]] · [[theory-50]] · [[theory-7]]

## Discovery suggestions

### Missing pages to create
- [ ] [[quantum-2-paper]] — canonical citation anchor

### Potential simulations
- **Radiation Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[theory-44]] — structural analogy
- [[theory-50]] — structural analogy
