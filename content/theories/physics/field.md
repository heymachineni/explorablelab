...
slug: "field"
title: "Optics"
summary: "Optics: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Optics is a core framework for reasoning about physics.

## Why this matters

Without grasping optics, practitioners in physics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Optics formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in optics. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing optics.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in optics | field-specific |
...
Reading about optics invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip optics from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under optics dynamics.
...
- **Education:** teach optics with sandbox labs before equations.
...
- [[large]] · [[law-4]] · [[learning]]

## Discovery suggestions

### Missing pages to create
- [ ] [[field-paper]] — canonical citation anchor

### Potential simulations
- **Optics Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[large]] — structural analogy
- [[law-4]] — structural analogy
