...
slug: "conservation-3"
title: "Third Law"
summary: "Third Law: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, third, law]
scores:
  visual_potential: 8
...
related:
  theories: [bifurcation, big, biogeography]
---

# Third Law

> **One-line essence:** Third Law links mechanism, prediction, and intervention in physics.

## Why this matters

Third Law sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in third law | field-specific |
...
Reading about third law invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip third law from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under third law dynamics.
...
- **Education:** teach third law with sandbox labs before equations.
...
- [[81-paradox]] · [[88-paradox]] · [[94-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[conservation-3-paper]] — canonical citation anchor

### Potential simulations
- **Third Law Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[81-paradox]] — structural analogy
