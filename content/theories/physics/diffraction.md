...
slug: "diffraction"
title: "Mechanism"
summary: "Mechanism: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [reproduction, reproduction-2, reputation]
---

# Mechanism

> **One-line essence:** Mechanism is a core framework for reasoning about physics.

## Why this matters

Without grasping mechanism, practitioners in physics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Mechanism formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in mechanism. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing mechanism.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in mechanism | field-specific |
...
Reading about mechanism invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip mechanism from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under mechanism dynamics.
...
- **Education:** teach mechanism with sandbox labs before equations.
...
- [[bootstrap-paradox]] · [[conjunction-fallacy]] · [[dichotomy-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[diffraction-paper]] — canonical citation anchor

### Potential simulations
- **Mechanism Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[bootstrap-paradox]] — structural analogy
- [[conjunction-fallacy]] — structural analogy
