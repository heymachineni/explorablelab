...
slug: "bell"
title: "Inflation"
summary: "Inflation: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, inflation]
scores:
  visual_potential: 7
...
related:
  theories: [active, active-2, adaptive]
---

# Inflation

> **One-line essence:** Inflation is a core framework for reasoning about physics.

## Why this matters

Without grasping inflation, practitioners in physics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Inflation formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in inflation. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing inflation.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in inflation | field-specific |
...
Reading about inflation invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip inflation from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under inflation dynamics.
...
- **Education:** teach inflation with sandbox labs before equations.
...
- [[divide]] · [[drift]] · [[dynamical]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bell-paper]] — canonical citation anchor

### Potential simulations
- **Inflation Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[divide]] — structural analogy
- [[drift]] — structural analogy
