...
slug: "relativity"
title: "Stokes"
summary: "Stokes: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [consensus, consensus-2, conservation]
---

# Stokes

> **One-line essence:** Stokes links mechanism, prediction, and intervention in physics.

## Why this matters

Stokes sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in stokes. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing stokes.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in stokes | field-specific |
...
Reading about stokes invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip stokes from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under stokes dynamics.
...
- **Education:** teach stokes with sandbox labs before equations.
...
- [[complexity]] · [[concept-1-evolution]] · [[concept-16-probability]]

## Discovery suggestions

### Missing pages to create
- [ ] [[relativity-paper]] — canonical citation anchor

### Potential simulations
- **Stokes Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[complexity]] — structural analogy
- [[concept-1-evolution]] — structural analogy
