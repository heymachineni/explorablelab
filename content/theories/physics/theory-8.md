...
slug: "theory-8"
title: "Diffraction"
summary: "Diffraction: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, diffraction]
scores:
  visual_potential: 6
...
related:
  theories: [maximum, maxwell, maxwell-2]
---

# Diffraction

> **One-line essence:** Diffraction links mechanism, prediction, and intervention in physics.

## Why this matters

Diffraction sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in diffraction. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing diffraction.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in diffraction | field-specific |
...
Reading about diffraction invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip diffraction from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under diffraction dynamics.
...
- **Education:** teach diffraction with sandbox labs before equations.
...
- [[ravens-paradox]] · [[ship-paradox]] · [[sleeping-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theory-8-paper]] — canonical citation anchor

### Potential simulations
- **Diffraction Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[ravens-paradox]] — structural analogy
- [[ship-paradox]] — structural analogy
