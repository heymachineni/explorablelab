...
slug: "energy-2"
title: "Momentum"
summary: "Momentum: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [theory-4, theory-40, theory-41]
---

# Momentum

> **One-line essence:** Momentum is a core framework for reasoning about physics.

## Why this matters

Without grasping momentum, practitioners in physics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Momentum formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in momentum. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing momentum.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in momentum | field-specific |
...
Reading about momentum invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip momentum from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under momentum dynamics.
...
- **Education:** teach momentum with sandbox labs before equations.
...
- [[convex]] · [[coupled-oscillators]] · [[cross]]

## Discovery suggestions

### Missing pages to create
- [ ] [[energy-2-paper]] — canonical citation anchor

### Potential simulations
- **Momentum Sandbox** — web-simulation — priority: high
