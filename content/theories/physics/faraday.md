...
slug: "faraday"
title: "Fusion"
summary: "Fusion: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Fusion links mechanism, prediction, and intervention in physics.

## Why this matters

Fusion sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in fusion. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing fusion.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in fusion | field-specific |
...
Reading about fusion invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip fusion from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under fusion dynamics.
...
- **Education:** teach fusion with sandbox labs before equations.
...
- [ ] [[faraday-paper]] — canonical citation anchor

### Potential simulations
- **Fusion Sandbox** — web-simulation — priority: high
