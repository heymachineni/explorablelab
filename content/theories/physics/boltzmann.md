...
summary: "Pilot Wave Theory: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, pilot, wave, theory]
scores:
  visual_potential: 6
...
> **One-line essence:** Pilot Wave Theory links mechanism, prediction, and intervention in physics.

## Why this matters

Pilot Wave Theory sits at the fault line between intuition and evidence in physics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in pilot wave theory. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing pilot wave theory.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in pilot wave theory | field-specific |
...
Reading about pilot wave theory invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip pilot wave theory from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under pilot wave theory dynamics.
...
- **Education:** teach pilot wave theory with sandbox labs before equations.
...
- [[109-paradox]] · [[115-paradox]] · [[121-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[boltzmann-paper]] — canonical citation anchor

### Potential simulations
- **Pilot Wave Theory Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[109-paradox]] — structural analogy
- [[115-paradox]] — structural analogy
