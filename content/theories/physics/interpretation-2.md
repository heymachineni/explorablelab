...
id: "THY-0326"
type: "theory"
slug: "interpretation-2"
title: "Lenz Law"
summary: "Lenz Law: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [physics, lenz, law]
scores:
  visual_potential: 9
...
related:
  theories: [availability, aversion, aversion-2]
---

# Lenz Law

> **One-line essence:** Lenz Law is a core framework for reasoning about physics.

## Why this matters

Without grasping lenz law, practitioners in physics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Lenz Law formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in lenz law. Under standard assumptions in physics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing lenz law.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in lenz law | field-specific |
...
Reading about lenz law invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip lenz law from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under lenz law dynamics.
...
- **Education:** teach lenz law with sandbox labs before equations.
...
- [[motivated]] · [[nash-2]] · [[network]]

## Discovery suggestions

### Missing pages to create
- [ ] [[interpretation-2-paper]] — canonical citation anchor

### Potential simulations
- **Lenz Law Sandbox** — web-simulation — priority: high
