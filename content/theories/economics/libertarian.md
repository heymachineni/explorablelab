...
related:
  theories: [linear, linear-2, lm]
---

# Black

> **One-line essence:** Black is a core framework for reasoning about economics.

## Why this matters

Without grasping black, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.
...
Let **X** denote the primary state variable in black. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [[bias-7]] · [[biology-2]] · [[blindness-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[libertarian-paper]] — canonical citation anchor
