...
slug: "general-2"
title: "Tragedy"
summary: "Tragedy: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, tragedy]
scores:
  visual_potential: 8
...
> **One-line essence:** Tragedy links mechanism, prediction, and intervention in economics.

## Why this matters

Tragedy sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in tragedy. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing tragedy.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in tragedy | field-specific |
...
Reading about tragedy invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip tragedy from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under tragedy dynamics.
...
- **Education:** teach tragedy with sandbox labs before equations.
...
- [[signaling]] · [[social-2]] · [[social-choice]]

## Discovery suggestions

### Missing pages to create
- [ ] [[general-2-paper]] — canonical citation anchor

### Potential simulations
- **Tragedy Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[signaling]] — structural analogy
- [[social-2]] — structural analogy
