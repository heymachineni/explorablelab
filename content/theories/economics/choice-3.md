...
type: "theory"
slug: "choice-3"
title: "Antifragility Goodharts Law"
summary: "Antifragility Goodharts Law: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, antifragility, goodharts, law]
scores:
  visual_potential: 7
...
# Antifragility Goodharts Law

> **One-line essence:** Antifragility Goodharts Law is a core framework for reasoning about economics.

## Why this matters

Without grasping antifragility goodharts law, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Antifragility Goodharts Law formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in antifragility goodharts law. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing antifragility goodharts law.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in antifragility goodharts law | field-specific |
...
Reading about antifragility goodharts law invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip antifragility goodharts law from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under antifragility goodharts law dynamics.
...
- **Education:** teach antifragility goodharts law with sandbox labs before equations.
...
- [[interference]] · [[island]] · [[keystone]]

## Discovery suggestions

### Missing pages to create
- [ ] [[choice-3-paper]] — canonical citation anchor

### Potential simulations
- **Antifragility Goodharts Law Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[interference]] — structural analogy
- [[island]] — structural analogy
