...
slug: "principal"
title: "Expectations"
summary: "Expectations: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [self-organized-criticality, semiconductor, sequencing]
---

# Expectations

> **One-line essence:** Expectations links mechanism, prediction, and intervention in economics.

## Why this matters

Expectations sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
2. Specify update rules or conservation laws governing expectations.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in expectations | field-specific |
...
Reading about expectations invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip expectations from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under expectations dynamics.
...
- **Education:** teach expectations with sandbox labs before equations.
...
- [[paradox-183]] · [[paradox-19]] · [[paradox-196]]

## Discovery suggestions

### Missing pages to create
- [ ] [[principal-paper]] — canonical citation anchor

### Potential simulations
- **Expectations Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-183]] — structural analogy
- [[paradox-19]] — structural analogy
