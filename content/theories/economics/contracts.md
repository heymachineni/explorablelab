...
slug: "contracts"
title: "Pricing"
summary: "Pricing: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Pricing links mechanism, prediction, and intervention in economics.

## Why this matters

Pricing sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in pricing. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing pricing.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in pricing | field-specific |
...
Reading about pricing invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip pricing from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under pricing dynamics.
...
- **Education:** teach pricing with sandbox labs before equations.
...
- [[concept-3-information-theory]] · [[condorcet]] · [[consensus]]

## Discovery suggestions

### Missing pages to create
- [ ] [[contracts-paper]] — canonical citation anchor

### Potential simulations
- **Pricing Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[concept-3-information-theory]] — structural analogy
