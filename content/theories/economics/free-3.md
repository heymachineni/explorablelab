...
slug: "free-3"
title: "Subgame"
summary: "Subgame: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [gulf, habitus, halo]
---

# Subgame

> **One-line essence:** Subgame links mechanism, prediction, and intervention in economics.

## Why this matters

Subgame sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in subgame. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing subgame.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in subgame | field-specific |
...
Reading about subgame invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip subgame from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under subgame dynamics.
...
- **Education:** teach subgame with sandbox labs before equations.
...
- [ ] [[free-3-paper]] — canonical citation anchor

### Potential simulations
- **Subgame Sandbox** — web-simulation — priority: high
