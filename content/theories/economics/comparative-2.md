...
> **One-line essence:** Public is a core framework for reasoning about economics.

## Why this matters

Without grasping public, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.
...
Let **X** denote the primary state variable in public. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [[theory-3]] · [[theory-36]] · [[theory-42]]

## Discovery suggestions

### Missing pages to create
- [ ] [[comparative-2-paper]] — canonical citation anchor

### Potential simulations
- **Public Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[theory-3]] — structural analogy
- [[theory-36]] — structural analogy
