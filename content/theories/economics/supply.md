...
slug: "supply"
title: "Utility"
summary: "Utility: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, utility]
scores:
  visual_potential: 7
...
> **One-line essence:** Utility is a core framework for reasoning about economics.

## Why this matters

Without grasping utility, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Utility formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in utility. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing utility.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in utility | field-specific |
...
Reading about utility invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip utility from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under utility dynamics.
...
- **Education:** teach utility with sandbox labs before equations.
...
- [[learning-5]] · [[likelihood]] · [[loafing]]

## Discovery suggestions

### Missing pages to create
- [ ] [[supply-paper]] — canonical citation anchor

### Potential simulations
- **Utility Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[learning-5]] — structural analogy
- [[likelihood]] — structural analogy
