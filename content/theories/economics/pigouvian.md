...
slug: "pigouvian"
title: "Folk Theorem"
summary: "Folk Theorem: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, folk, theorem]
scores:
  visual_potential: 8
...
> **One-line essence:** Folk Theorem is a core framework for reasoning about economics.

## Why this matters

Without grasping folk theorem, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Folk Theorem formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in folk theorem. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing folk theorem.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in folk theorem | field-specific |
...
Reading about folk theorem invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip folk theorem from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under folk theorem dynamics.
...
- **Education:** teach folk theorem with sandbox labs before equations.
...
- [[neutral-2]] · [[np-2]] · [[numbers]]

## Discovery suggestions

### Missing pages to create
- [ ] [[pigouvian-paper]] — canonical citation anchor

### Potential simulations
- **Folk Theorem Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[neutral-2]] — structural analogy
- [[np-2]] — structural analogy
