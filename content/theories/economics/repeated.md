...
slug: "repeated"
title: "Phillips"
summary: "Phillips: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, phillips]
scores:
  visual_potential: 7
...
related:
  theories: [cross, cryptography, cultural]
---

# Phillips

> **One-line essence:** Phillips links mechanism, prediction, and intervention in economics.

## Why this matters

Phillips sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in phillips. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing phillips.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in phillips | field-specific |
...
Reading about phillips invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip phillips from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under phillips dynamics.
...
- **Education:** teach phillips with sandbox labs before equations.
...
- [[logical-paradox-72]] · [[logical-paradox-79]] · [[logical-paradox-85]]

## Discovery suggestions

### Missing pages to create
- [ ] [[repeated-paper]] — canonical citation anchor

### Potential simulations
- **Phillips Sandbox** — web-simulation — priority: high
