...
related:
  theories: [backfire, backpropagation, ball]
---

# Mechanism

> **One-line essence:** Mechanism links mechanism, prediction, and intervention in economics.

## Why this matters

Mechanism sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in mechanism. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [ ] [[game-paper]] — canonical citation anchor
