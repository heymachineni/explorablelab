...
summary: "Partial Equilibrium: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, partial, equilibrium]
scores:
  visual_potential: 7
...
related:
  theories: [social-2, social-3, social-4]
---

# Partial Equilibrium

> **One-line essence:** Partial Equilibrium links mechanism, prediction, and intervention in economics.

## Why this matters

Partial Equilibrium sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in partial equilibrium. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing partial equilibrium.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in partial equilibrium | field-specific |
...
Reading about partial equilibrium invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip partial equilibrium from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under partial equilibrium dynamics.
...
- **Education:** teach partial equilibrium with sandbox labs before equations.
...
- [ ] [[advantage-paper]] — canonical citation anchor

### Potential simulations
- **Partial Equilibrium Sandbox** — web-simulation — priority: high
