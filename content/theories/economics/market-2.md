...
type: "theory"
slug: "market-2"
title: "Hold Up Problem"
summary: "Hold Up Problem: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, hold, problem]
scores:
  visual_potential: 8
...
related:
  theories: [cryptography, cultural, cultural-2]
---

# Hold Up Problem

> **One-line essence:** Hold Up Problem links mechanism, prediction, and intervention in economics.

## Why this matters

Hold Up Problem sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in hold up problem. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing hold up problem.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in hold up problem | field-specific |
...
Reading about hold up problem invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip hold up problem from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under hold up problem dynamics.
...
- **Education:** teach hold up problem with sandbox labs before equations.
...
- [[homotopy]] · [[hypothesis]] · [[hypothesis-6]]

## Discovery suggestions

### Missing pages to create
- [ ] [[market-2-paper]] — canonical citation anchor

### Potential simulations
- **Hold Up Problem Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[homotopy]] — structural analogy
