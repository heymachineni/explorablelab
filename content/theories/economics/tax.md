...
summary: "Repeated Games: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, repeated, games]
scores:
  visual_potential: 8
...
related:
  theories: [law-2, law-3, law-4]
---

# Repeated Games

> **One-line essence:** Repeated Games is a core framework for reasoning about economics.

## Why this matters

Without grasping repeated games, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Repeated Games formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in repeated games. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing repeated games.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in repeated games | field-specific |
...
Reading about repeated games invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip repeated games from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under repeated games dynamics.
...
- **Education:** teach repeated games with sandbox labs before equations.
...
- [[transport-2]] · [[turing]] · [[urbanization]]

## Discovery suggestions

### Missing pages to create
- [ ] [[tax-paper]] — canonical citation anchor

### Potential simulations
- **Repeated Games Sandbox** — web-simulation — priority: high
