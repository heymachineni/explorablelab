...
slug: "utility"
title: "Comparative"
summary: "Comparative: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, comparative]
scores:
  visual_potential: 6
...
related:
  theories: [agent, ai, algebra]
---

# Comparative

> **One-line essence:** Comparative is a core framework for reasoning about economics.

## Why this matters

Without grasping comparative, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Comparative formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in comparative. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing comparative.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in comparative | field-specific |
...
Reading about comparative invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip comparative from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under comparative dynamics.
...
- **Education:** teach comparative with sandbox labs before equations.
...
- [ ] [[utility-paper]] — canonical citation anchor

### Potential simulations
- **Comparative Sandbox** — web-simulation — priority: high
