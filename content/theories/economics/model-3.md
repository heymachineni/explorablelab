...
slug: "model-3"
title: "Seeking"
summary: "Seeking: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, seeking]
scores:
  visual_potential: 8
...
> **One-line essence:** Seeking links mechanism, prediction, and intervention in economics.

## Why this matters

Seeking sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in seeking. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing seeking.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in seeking | field-specific |
...
Reading about seeking invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip seeking from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under seeking dynamics.
...
- **Education:** teach seeking with sandbox labs before equations.
...
- [ ] [[model-3-paper]] — canonical citation anchor

### Potential simulations
- **Seeking Sandbox** — web-simulation — priority: high
