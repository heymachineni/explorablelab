...
type: "theory"
slug: "option"
title: "Partial Equilibrium × Pigouvian (11)"
summary: "Partial Equilibrium × Pigouvian (11): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, partial, equilibrium, pigouvian]
scores:
  visual_potential: 6
...
# Partial Equilibrium × Pigouvian (11)

> **One-line essence:** Partial Equilibrium × Pigouvian (11) links mechanism, prediction, and intervention in economics.

## Why this matters

Partial Equilibrium × Pigouvian (11) sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in partial equilibrium × pigouvian (11) | field-specific |
...
Reading about partial equilibrium × pigouvian (11) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip partial equilibrium × pigouvian (11) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under partial equilibrium × pigouvian (11) dynamics.
...
- **Education:** teach partial equilibrium × pigouvian (11) with sandbox labs before equations.
...
- [ ] [[option-paper]] — canonical citation anchor

### Potential simulations
- **Partial Equilibrium × Pigouvian (11) Sandbox** — web-simulation — priority: high
