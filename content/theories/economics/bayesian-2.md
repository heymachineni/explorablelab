...
slug: "bayesian-2"
title: "Accounting"
summary: "Accounting: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Accounting links mechanism, prediction, and intervention in economics.

## Why this matters

Accounting sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in accounting. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing accounting.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in accounting | field-specific |
...
Reading about accounting invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip accounting from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under accounting dynamics.
...
- **Education:** teach accounting with sandbox labs before equations.
...
- [[choice-5]] · [[clustering]] · [[cognitive]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bayesian-2-paper]] — canonical citation anchor

### Potential simulations
- **Accounting Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[choice-5]] — structural analogy
- [[clustering]] — structural analogy
