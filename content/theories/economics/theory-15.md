...
slug: "theory-15"
title: "Implicit"
summary: "Implicit: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, implicit]
scores:
  visual_potential: 7
...
related:
  theories: [deep, default, default-2]
---

# Implicit

> **One-line essence:** Implicit links mechanism, prediction, and intervention in economics.

## Why this matters

Implicit sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in implicit. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing implicit.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in implicit | field-specific |
...
Reading about implicit invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip implicit from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under implicit dynamics.
...
- **Education:** teach implicit with sandbox labs before equations.
...
- [[paradox-249]] · [[paradox-30]] · [[paradox-37]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theory-15-paper]] — canonical citation anchor

### Potential simulations
- **Implicit Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-249]] — structural analogy
