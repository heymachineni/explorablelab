...
related:
  theories: [implicit, impossibility, impossibility-2]
---

# Choice

> **One-line essence:** Choice explains how local rules produce global patterns in economics.
...
Let **X** denote the primary state variable in choice. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [[mechanism-3]] · [[mental]] · [[mind]]

## Discovery suggestions

### Missing pages to create
- [ ] [[stable-paper]] — canonical citation anchor
