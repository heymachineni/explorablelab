...
slug: "is"
title: "Capture"
summary: "Capture: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, capture]
scores:
  visual_potential: 6
...
related:
  theories: [equilibrium-4, equilibrium-5, equilibrium-6]
---

# Capture

> **One-line essence:** Capture links mechanism, prediction, and intervention in economics.

## Why this matters

Capture sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in capture. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing capture.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in capture | field-specific |
...
Reading about capture invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip capture from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under capture dynamics.
...
- **Education:** teach capture with sandbox labs before equations.
...
- [[zipf-word-mountain]] · [[104-paradox]] · [[110-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[is-paper]] — canonical citation anchor

### Potential simulations
- **Capture Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[zipf-word-mountain]] — structural analogy
- [[104-paradox]] — structural analogy
