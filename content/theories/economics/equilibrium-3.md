...
slug: "equilibrium-3"
title: "Behavioral"
summary: "Behavioral: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Behavioral links mechanism, prediction, and intervention in economics.

## Why this matters

Behavioral sits at the fault line between intuition and evidence in economics; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in behavioral | field-specific |
...
Reading about behavioral invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip behavioral from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under behavioral dynamics.
...
- **Education:** teach behavioral with sandbox labs before equations.
...
- [[logical-paradox-30]] · [[logical-paradox-37]] · [[logical-paradox-43]]

## Discovery suggestions

### Missing pages to create
- [ ] [[equilibrium-3-paper]] — canonical citation anchor

### Potential simulations
- **Behavioral Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[logical-paradox-30]] — structural analogy
- [[logical-paradox-37]] — structural analogy
