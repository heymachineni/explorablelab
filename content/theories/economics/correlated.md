...
slug: "correlated"
title: "Nudge"
summary: "Nudge: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [economics, nudge]
scores:
  visual_potential: 7
...
> **One-line essence:** Nudge is a core framework for reasoning about economics.

## Why this matters

Without grasping nudge, practitioners in economics overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Nudge formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in nudge. Under standard assumptions in economics, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing nudge.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in nudge | field-specific |
...
Reading about nudge invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip nudge from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under nudge dynamics.
...
- **Education:** teach nudge with sandbox labs before equations.
...
- [[137-paradox]] · [[143-paradox]] · [[15-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[correlated-paper]] — canonical citation anchor

### Potential simulations
- **Nudge Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[137-paradox]] — structural analogy
- [[143-paradox]] — structural analogy
