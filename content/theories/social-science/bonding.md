...
> **One-line essence:** Logic links mechanism, prediction, and intervention in social science.

## Why this matters

Logic sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in logic. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [[monetarism]] · [[multilevel]] · [[natural-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bonding-paper]] — canonical citation anchor

### Potential simulations
- **Logic Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[monetarism]] — structural analogy
- [[multilevel]] — structural analogy
