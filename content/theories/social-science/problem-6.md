...
type: "theory"
slug: "problem-6"
title: "Spatial Mismatch Hypothesis"
summary: "Spatial Mismatch Hypothesis: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, spatial, mismatch, hypothesis]
scores:
  visual_potential: 8
...
related:
  theories: [overload, p, paging]
---

# Spatial Mismatch Hypothesis

> **One-line essence:** Spatial Mismatch Hypothesis links mechanism, prediction, and intervention in social science.

## Why this matters

Spatial Mismatch Hypothesis sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in spatial mismatch hypothesis. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing spatial mismatch hypothesis.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in spatial mismatch hypothesis | field-specific |
...
Reading about spatial mismatch hypothesis invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip spatial mismatch hypothesis from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under spatial mismatch hypothesis dynamics.
...
- **Education:** teach spatial mismatch hypothesis with sandbox labs before equations.
...
- [[ecology-2]] · [[effect]] · [[effect-16]]

## Discovery suggestions

### Missing pages to create
- [ ] [[problem-6-paper]] — canonical citation anchor

### Potential simulations
- **Spatial Mismatch Hypothesis Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[ecology-2]] — structural analogy
- [[effect]] — structural analogy
