...
slug: "association"
title: "Society"
summary: "Society: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, society]
scores:
  visual_potential: 7
...
related:
  theories: [geometry, geometry-2, geometry-3]
---

# Society

> **One-line essence:** Society links mechanism, prediction, and intervention in social science.

## Why this matters

Society sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
2. Specify update rules or conservation laws governing society.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in society | field-specific |
...
Reading about society invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip society from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under society dynamics.
...
- **Education:** teach society with sandbox labs before equations.
...
- [ ] [[association-paper]] — canonical citation anchor

### Potential simulations
- **Society Sandbox** — web-simulation — priority: high
