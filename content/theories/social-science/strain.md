...
related:
  theories: [choice-2, choice-3, choice-4]
---

# Cultural

> **One-line essence:** Cultural links mechanism, prediction, and intervention in social science.

## Why this matters

Cultural sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in cultural. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [ ] [[strain-paper]] — canonical citation anchor
