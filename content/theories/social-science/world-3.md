...
type: "theory"
slug: "world-3"
title: "Divide × Holes (18)"
summary: "Divide × Holes (18): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, divide, holes]
scores:
  visual_potential: 8
...
> **One-line essence:** Divide × Holes (18) is a core framework for reasoning about social science.

## Why this matters

Without grasping divide × holes (18), practitioners in social science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Divide × Holes (18) formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in divide × holes (18). Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing divide × holes (18).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in divide × holes (18) | field-specific |
...
Reading about divide × holes (18) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip divide × holes (18) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under divide × holes (18) dynamics.
...
- **Education:** teach divide × holes (18) with sandbox labs before equations.
...
- [[hypothesis-11]] · [[hypothesis-8]] · [[illusory]]

## Discovery suggestions

### Missing pages to create
- [ ] [[world-3-paper]] — canonical citation anchor

### Potential simulations
- **Divide × Holes (18) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[hypothesis-11]] — structural analogy
- [[hypothesis-8]] — structural analogy
