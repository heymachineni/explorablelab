...
slug: "capital-3"
title: "Olson"
summary: "Olson: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, olson]
scores:
  visual_potential: 7
...
related:
  theories: [functional, functionalism, functions]
---

# Olson

> **One-line essence:** Olson links mechanism, prediction, and intervention in social science.

## Why this matters

Olson sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in olson. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing olson.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in olson | field-specific |
...
Reading about olson invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip olson from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under olson dynamics.
...
- **Education:** teach olson with sandbox labs before equations.
...
- [[mechanics-5]] · [[membrane]] · [[mhc]]

## Discovery suggestions

### Missing pages to create
- [ ] [[capital-3-paper]] — canonical citation anchor

### Potential simulations
- **Olson Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[mechanics-5]] — structural analogy
