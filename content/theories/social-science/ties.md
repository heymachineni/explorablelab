...
related:
  theories: [pricing-3, prime, priming]
---

# Mobilization

> **One-line essence:** Mobilization explains how local rules produce global patterns in social science.

## Why this matters

Policymakers, educators, and designers misapply mobilization when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, mobilization describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.
...
- [ ] [[ties-paper]] — canonical citation anchor
