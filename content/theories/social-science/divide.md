...
slug: "divide"
title: "Free"
summary: "Free: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [prime, priming, principal]
---

# Free

> **One-line essence:** Free explains how local rules produce global patterns in social science.

## Why this matters

Policymakers, educators, and designers misapply free when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, free describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in free. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing free.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in free | field-specific |
...
Reading about free invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip free from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under free dynamics.
...
- **Education:** teach free with sandbox labs before equations.
...
- [ ] [[divide-paper]] — canonical citation anchor

### Potential simulations
- **Free Sandbox** — web-simulation — priority: high
