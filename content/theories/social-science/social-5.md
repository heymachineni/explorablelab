...
slug: "social-5"
title: "Digital"
summary: "Digital: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, digital]
scores:
  visual_potential: 6
...
> **One-line essence:** Digital explains how local rules produce global patterns in social science.

## Why this matters

Policymakers, educators, and designers misapply digital when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, digital describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in digital. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing digital.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in digital | field-specific |
...
Reading about digital invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip digital from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under digital dynamics.
...
- **Education:** teach digital with sandbox labs before equations.
...
- [[paradox-90]] · [[paradox-97]] · [[petrie-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[social-5-paper]] — canonical citation anchor

### Potential simulations
- **Digital Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-90]] — structural analogy
- [[paradox-97]] — structural analogy
