...
slug: "habitus"
title: "Weak"
summary: "Weak: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, weak]
scores:
  visual_potential: 7
...
> **One-line essence:** Weak links mechanism, prediction, and intervention in social science.

## Why this matters

Weak sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
2. Specify update rules or conservation laws governing weak.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in weak | field-specific |
...
Reading about weak invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip weak from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under weak dynamics.
...
- **Education:** teach weak with sandbox labs before equations.
...
- [[equations]] · [[equilibrium-6]] · [[euler]]

## Discovery suggestions

### Missing pages to create
- [ ] [[habitus-paper]] — canonical citation anchor

### Potential simulations
- **Weak Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[equations]] — structural analogy
- [[equilibrium-6]] — structural analogy
