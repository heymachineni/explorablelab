...
updated: "2026-06-26"
confidence: "medium"
tags: [social-science, differential]
scores:
  visual_potential: 8
...
> **One-line essence:** Differential links mechanism, prediction, and intervention in social science.

## Why this matters

Differential sits at the fault line between intuition and evidence in social science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in differential. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [ ] [[theory-46-paper]] — canonical citation anchor
