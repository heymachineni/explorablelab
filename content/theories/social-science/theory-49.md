...
> **One-line essence:** Social is a core framework for reasoning about social science.

## Why this matters

Without grasping social, practitioners in social science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.
...
Let **X** denote the primary state variable in social. Under standard assumptions in social science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.
...
- [ ] [[theory-49-paper]] — canonical citation anchor
