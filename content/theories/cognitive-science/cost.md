...
slug: "cost"
title: "Diffusion"
summary: "Diffusion: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, diffusion]
scores:
  visual_potential: 7
...
> **One-line essence:** Diffusion links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Diffusion sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in diffusion. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing diffusion.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in diffusion | field-specific |
...
Reading about diffusion invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip diffusion from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under diffusion dynamics.
...
- **Education:** teach diffusion with sandbox labs before equations.
...
- [[concept-10-information-theory]] · [[concept-17-information-theory]] · [[concept-23-probability]]

## Discovery suggestions

### Missing pages to create
- [ ] [[cost-paper]] — canonical citation anchor

### Potential simulations
- **Diffusion Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[concept-10-information-theory]] — structural analogy
- [[concept-17-information-theory]] — structural analogy
