...
slug: "bystander"
title: "Mind"
summary: "Mind: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, mind]
scores:
  visual_potential: 7
...
> **One-line essence:** Mind links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Mind sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in mind | field-specific |
...
Reading about mind invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip mind from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under mind dynamics.
...
- **Education:** teach mind with sandbox labs before equations.
...
- [[simulation-argument]] · [[spurious-paradox]] · [[theory-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bystander-paper]] — canonical citation anchor

### Potential simulations
- **Mind Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[simulation-argument]] — structural analogy
- [[spurious-paradox]] — structural analogy
