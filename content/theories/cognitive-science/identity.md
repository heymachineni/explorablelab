...
type: "theory"
slug: "identity"
title: "Loafing × Door (72)"
summary: "Loafing × Door (72): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, loafing, door]
scores:
  visual_potential: 8
...
related:
  theories: [selection-2, selection-3, selection-4]
---

# Loafing × Door (72)

> **One-line essence:** Loafing × Door (72) links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Loafing × Door (72) sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in loafing × door (72). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing loafing × door (72).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in loafing × door (72) | field-specific |
...
Reading about loafing × door (72) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip loafing × door (72) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under loafing × door (72) dynamics.
...
- **Education:** teach loafing × door (72) with sandbox labs before equations.
...
- [ ] [[identity-paper]] — canonical citation anchor

### Potential simulations
- **Loafing × Door (72) Sandbox** — web-simulation — priority: high
