...
type: "theory"
slug: "shift-2"
title: "Confirmation Bias × Spacing Effect (7)"
summary: "Confirmation Bias × Spacing Effect (7): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, confirmation, bias, spacing, effect]
scores:
  visual_potential: 6
...
related:
  theories: [spacetime, spacing, spatial]
---

# Confirmation Bias × Spacing Effect (7)

> **One-line essence:** Confirmation Bias × Spacing Effect (7) links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Confirmation Bias × Spacing Effect (7) sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in confirmation bias × spacing effect (7). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing confirmation bias × spacing effect (7).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in confirmation bias × spacing effect (7) | field-specific |
...
Reading about confirmation bias × spacing effect (7) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip confirmation bias × spacing effect (7) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under confirmation bias × spacing effect (7) dynamics.
...
- **Education:** teach confirmation bias × spacing effect (7) with sandbox labs before equations.
...
- [[radiation-2]] · [[rational]] · [[red]]

## Discovery suggestions

### Missing pages to create
- [ ] [[shift-2-paper]] — canonical citation anchor

### Potential simulations
- **Confirmation Bias × Spacing Effect (7) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[radiation-2]] — structural analogy
- [[rational]] — structural analogy
