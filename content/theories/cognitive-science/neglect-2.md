...
type: "theory"
slug: "neglect-2"
title: "Loss × Illusion (32)"
summary: "Loss × Illusion (32): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, loss, illusion]
scores:
  visual_potential: 7
...
> **One-line essence:** Loss × Illusion (32) links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Loss × Illusion (32) sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in loss × illusion (32). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing loss × illusion (32).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in loss × illusion (32) | field-specific |
...
Reading about loss × illusion (32) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip loss × illusion (32) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under loss × illusion (32) dynamics.
...
- **Education:** teach loss × illusion (32) with sandbox labs before equations.
...
- [[coordination-paradox]] · [[dilemma-paradox]] · [[efficiency-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[neglect-2-paper]] — canonical citation anchor

### Potential simulations
- **Loss × Illusion (32) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[coordination-paradox]] — structural analogy
- [[dilemma-paradox]] — structural analogy
