...
slug: "spotlight"
title: "Face"
summary: "Face: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, face]
scores:
  visual_potential: 6
...
related:
  theories: [law-6, law-7, law-8]
---

# Face

> **One-line essence:** Face is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping face, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Face formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in face. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing face.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in face | field-specific |
...
Reading about face invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip face from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under face dynamics.
...
- **Education:** teach face with sandbox labs before equations.
...
- [ ] [[spotlight-paper]] — canonical citation anchor

### Potential simulations
- **Face Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[predator]] — structural analogy
- [[pricing-2]] — structural analogy
