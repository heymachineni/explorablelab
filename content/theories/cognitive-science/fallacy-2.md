...
slug: "fallacy-2"
title: "Fallacy"
summary: "Fallacy: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, fallacy]
scores:
  visual_potential: 6
...
related:
  theories: [neuron, neuroscience, neutral]
---

# Fallacy

> **One-line essence:** Fallacy is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping fallacy, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Fallacy formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in fallacy. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing fallacy.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in fallacy | field-specific |
...
Reading about fallacy invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip fallacy from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under fallacy dynamics.
...
- **Education:** teach fallacy with sandbox labs before equations.
...
- [[unsupervised]] · [[variables]] · [[virtual]]

## Discovery suggestions

### Missing pages to create
- [ ] [[fallacy-2-paper]] — canonical citation anchor

### Potential simulations
- **Fallacy Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[unsupervised]] — structural analogy
- [[variables]] — structural analogy
