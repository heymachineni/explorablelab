...
id: "THY-0024"
type: "theory"
slug: "cognitive-biases-overview"
title: "Blindness"
summary: "Blindness: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, blindness]
scores:
  visual_potential: 8
...
related:
  theories: [effect-21, effect-22, effect-23]
---

# Blindness

> **One-line essence:** Blindness is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping blindness, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Blindness formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in blindness. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing blindness.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in blindness | field-specific |
...
Reading about blindness invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip blindness from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under blindness dynamics.
...
- **Education:** teach blindness with sandbox labs before equations.
...
- [ ] [[cognitive-biases-overview-paper]] — canonical citation anchor

### Potential simulations
- **Blindness Sandbox** — web-simulation — priority: high
