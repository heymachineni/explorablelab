...
type: "theory"
slug: "theory-2"
title: "Curse × Self Serving Bias (46)"
summary: "Curse × Self Serving Bias (46): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, curse, self, serving, bias]
scores:
  visual_potential: 7
...
related:
  theories: [aversion-2, axiom, axioms]
---

# Curse × Self Serving Bias (46)

> **One-line essence:** Curse × Self Serving Bias (46) links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Curse × Self Serving Bias (46) sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in curse × self serving bias (46). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing curse × self serving bias (46).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in curse × self serving bias (46) | field-specific |
...
Reading about curse × self serving bias (46) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip curse × self serving bias (46) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under curse × self serving bias (46) dynamics.
...
- **Education:** teach curse × self serving bias (46) with sandbox labs before equations.
...
- [[jevons-paradox]] · [[logical-paradox]] · [[logical-paradox-105]]

## Discovery suggestions

### Missing pages to create
- [ ] [[theory-2-paper]] — canonical citation anchor

### Potential simulations
- **Curse × Self Serving Bias (46) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[jevons-paradox]] — structural analogy
- [[logical-paradox]] — structural analogy
