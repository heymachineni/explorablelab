...
slug: "effect-10"
title: "Illusion"
summary: "Illusion: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, illusion]
scores:
  visual_potential: 6
...
related:
  theories: [theory-16, theory-17, theory-18]
---

# Illusion

> **One-line essence:** Illusion links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Illusion sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in illusion. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing illusion.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in illusion | field-specific |
...
Reading about illusion invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip illusion from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under illusion dynamics.
...
- **Education:** teach illusion with sandbox labs before equations.
...
- [[braess-paradox]] · [[correlation-paradox]] · [[dilemma-paradox-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[effect-10-paper]] — canonical citation anchor

### Potential simulations
- **Illusion Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[braess-paradox]] — structural analogy
