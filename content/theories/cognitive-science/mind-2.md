...
type: "theory"
slug: "mind-2"
title: "Norm × Dual Process (91)"
summary: "Norm × Dual Process (91): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, norm, dual, process]
scores:
  visual_potential: 6
...
related:
  theories: [computer, computer-2, concept]
---

# Norm × Dual Process (91)

> **One-line essence:** Norm × Dual Process (91) links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Norm × Dual Process (91) sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in norm × dual process (91). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing norm × dual process (91).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in norm × dual process (91) | field-specific |
...
Reading about norm × dual process (91) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip norm × dual process (91) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under norm × dual process (91) dynamics.
...
- **Education:** teach norm × dual process (91) with sandbox labs before equations.
...
- [[waiting-paradox]] · [[action]] · [[advantage]]

## Discovery suggestions

### Missing pages to create
- [ ] [[mind-2-paper]] — canonical citation anchor

### Potential simulations
- **Norm × Dual Process (91) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[waiting-paradox]] — structural analogy
- [[action]] — structural analogy
