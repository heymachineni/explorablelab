...
slug: "bias-4"
title: "Theory System"
summary: "Theory System: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, theory, system]
scores:
  visual_potential: 6
...
> **One-line essence:** Theory System is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping theory system, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Theory System formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in theory system. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing theory system.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in theory system | field-specific |
...
Reading about theory system invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip theory system from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under theory system dynamics.
...
- **Education:** teach theory system with sandbox labs before equations.
...
- [[paradox-59]] · [[paradox-65]] · [[paradox-71]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bias-4-paper]] — canonical citation anchor

### Potential simulations
- **Theory System Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-59]] — structural analogy
