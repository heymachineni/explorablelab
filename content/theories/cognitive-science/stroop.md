...
slug: "stroop"
title: "Inattentional"
summary: "Inattentional: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, inattentional]
scores:
  visual_potential: 8
...
related:
  theories: [gap-2, gene, gene-2]
---

# Inattentional

> **One-line essence:** Inattentional links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Inattentional sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in inattentional. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing inattentional.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in inattentional | field-specific |
...
Reading about inattentional invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip inattentional from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under inattentional dynamics.
...
- **Education:** teach inattentional with sandbox labs before equations.
...
- [[theory-55]] · [[thesis]] · [[trade-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[stroop-paper]] — canonical citation anchor

### Potential simulations
- **Inattentional Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[theory-55]] — structural analogy
- [[thesis]] — structural analogy
