...
slug: "bias-7"
title: "Hot Hand"
summary: "Hot Hand: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, hot, hand]
scores:
  visual_potential: 6
...
related:
  theories: [action-2, action-3, active]
---

# Hot Hand

> **One-line essence:** Hot Hand links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Hot Hand sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in hot hand. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing hot hand.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in hot hand | field-specific |
...
Reading about hot hand invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip hot hand from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under hot hand dynamics.
...
- **Education:** teach hot hand with sandbox labs before equations.
...
- [[170-paradox]] · [[177-paradox]] · [[183-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bias-7-paper]] — canonical citation anchor

### Potential simulations
- **Hot Hand Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[170-paradox]] — structural analogy
- [[177-paradox]] — structural analogy
