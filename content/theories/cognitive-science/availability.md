...
slug: "availability"
title: "Attribution"
summary: "Attribution: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, attribution]
scores:
  visual_potential: 8
...
> **One-line essence:** Attribution is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping attribution, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Attribution formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in attribution. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing attribution.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in attribution | field-specific |
...
Reading about attribution invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip attribution from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under attribution dynamics.
...
- **Education:** teach attribution with sandbox labs before equations.
...
- [[island-biogeography]] · [[lindy-library]] · [[median-voter-park]]

## Discovery suggestions

### Missing pages to create
- [ ] [[availability-paper]] — canonical citation anchor

### Potential simulations
- **Attribution Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[island-biogeography]] — structural analogy
