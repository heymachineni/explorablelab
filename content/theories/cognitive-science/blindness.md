...
summary: "Confirmation Bias: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, confirmation, bias]
scores:
  visual_potential: 7
...
related:
  theories: [concept-19-physics, concept-2-probability, concept-20-cognitive-science]
---

# Confirmation Bias

> **One-line essence:** Confirmation Bias links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Confirmation Bias sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in confirmation bias. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing confirmation bias.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in confirmation bias | field-specific |
...
Reading about confirmation bias invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip confirmation bias from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under confirmation bias dynamics.
...
- **Education:** teach confirmation bias with sandbox labs before equations.
...
- [[serial]] · [[shift-2]] · [[social]]

## Discovery suggestions

### Missing pages to create
- [ ] [[blindness-paper]] — canonical citation anchor

### Potential simulations
- **Confirmation Bias Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[serial]] — structural analogy
- [[shift-2]] — structural analogy
