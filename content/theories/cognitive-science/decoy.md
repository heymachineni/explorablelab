...
related:
  theories: [molecular, momentum, momentum-2]
---

# Shift

> **One-line essence:** Shift is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping shift, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Shift formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.
...
- [[1-paradox]] · [[105-paradox]] · [[111-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[decoy-paper]] — canonical citation anchor
