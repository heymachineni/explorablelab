...
summary: "Illusory Truth Effect: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, illusory, truth, effect]
scores:
  visual_potential: 6
...
related:
  theories: [friendship-paradox-club, fundamental-attribution-stage, galton-board]
---

# Illusory Truth Effect

> **One-line essence:** Illusory Truth Effect links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Illusory Truth Effect sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in illusory truth effect. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing illusory truth effect.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in illusory truth effect | field-specific |
...
Reading about illusory truth effect invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip illusory truth effect from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under illusory truth effect dynamics.
...
- **Education:** teach illusory truth effect with sandbox labs before equations.
...
- [[theory-17]] · [[theory-23]] · [[theory-3]]

## Discovery suggestions

### Missing pages to create
- [ ] [[dissonance-paper]] — canonical citation anchor

### Potential simulations
- **Illusory Truth Effect Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[theory-17]] — structural analogy
- [[theory-23]] — structural analogy
