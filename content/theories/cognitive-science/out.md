...
slug: "out"
title: "Belief Bias"
summary: "Belief Bias: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, belief, bias]
scores:
  visual_potential: 8
...
> **One-line essence:** Belief Bias links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Belief Bias sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in belief bias | field-specific |
...
Reading about belief bias invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip belief bias from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under belief bias dynamics.
...
- **Education:** teach belief bias with sandbox labs before equations.
...
- [ ] [[out-paper]] — canonical citation anchor

### Potential simulations
- **Belief Bias Sandbox** — web-simulation — priority: high
