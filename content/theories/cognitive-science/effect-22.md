...
slug: "effect-22"
title: "Effect 22"
summary: "Effect 22: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, effect]
scores:
  visual_potential: 7
...
> **One-line essence:** Effect 22 is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping effect 22, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Effect 22 formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in effect 22. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing effect 22.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in effect 22 | field-specific |
...
Reading about effect 22 invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip effect 22 from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under effect 22 dynamics.
...
- **Education:** teach effect 22 with sandbox labs before equations.
...
- [[gene-3]] · [[genes-2]] · [[geometry-3]]

## Discovery suggestions

### Missing pages to create
- [ ] [[effect-22-paper]] — canonical citation anchor

### Potential simulations
- **Effect 22 Sandbox** — web-simulation — priority: high
