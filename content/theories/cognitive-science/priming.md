...
slug: "priming"
title: "Base"
summary: "Base: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, base]
scores:
  visual_potential: 8
...
> **One-line essence:** Base links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Base sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in base. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing base.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in base | field-specific |
...
Reading about base invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip base from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under base dynamics.
...
- **Education:** teach base with sandbox labs before equations.
...
- [ ] [[priming-paper]] — canonical citation anchor

### Potential simulations
- **Base Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[hypothesis-9]] — structural analogy
- [[immune]] — structural analogy
