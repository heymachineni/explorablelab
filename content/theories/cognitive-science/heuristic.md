...
slug: "heuristic"
title: "Error"
summary: "Error: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, error]
scores:
  visual_potential: 6
...
> **One-line essence:** Error explains how local rules produce global patterns in cognitive science.

## Why this matters

Policymakers, educators, and designers misapply error when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, error describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.
...
2. Specify update rules or conservation laws governing error.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in error | field-specific |
...
Reading about error invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip error from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under error dynamics.
...
- **Education:** teach error with sandbox labs before equations.
...
- [[paradox-179]] · [[paradox-185]] · [[paradox-191]]

## Discovery suggestions

### Missing pages to create
- [ ] [[heuristic-paper]] — canonical citation anchor

### Potential simulations
- **Error Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-179]] — structural analogy
- [[paradox-185]] — structural analogy
