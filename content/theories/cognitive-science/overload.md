...
slug: "overload"
title: "Overload"
summary: "Overload: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, overload]
scores:
  visual_potential: 8
...
related:
  theories: [stroop-storm, structural-hole-broker, sunk-cost-tunnel]
---

# Overload

> **One-line essence:** Overload is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping overload, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Overload formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in overload. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing overload.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in overload | field-specific |
...
Reading about overload invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip overload from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under overload dynamics.
...
- **Education:** teach overload with sandbox labs before equations.
...
- [[theory-16]] · [[theory-22]] · [[theory-29]]

## Discovery suggestions

### Missing pages to create
- [ ] [[overload-paper]] — canonical citation anchor

### Potential simulations
- **Overload Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[theory-16]] — structural analogy
