...
slug: "endowment"
title: "Social"
summary: "Social: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [public-2, public-3, punctuated]
---

# Social

> **One-line essence:** Social is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping social, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Social formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in social. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing social.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in social | field-specific |
...
Reading about social invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip social from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under social dynamics.
...
- **Education:** teach social with sandbox labs before equations.
...
- [[criticality]] · [[curvature]] · [[dark-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[endowment-paper]] — canonical citation anchor

### Potential simulations
- **Social Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[criticality]] — structural analogy
- [[curvature]] — structural analogy
