...
summary: "Mere Exposure Effect: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, mere, exposure, effect]
scores:
  visual_potential: 8
...
related:
  theories: [gibbard, godel, good]
---

# Mere Exposure Effect

> **One-line essence:** Mere Exposure Effect is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping mere exposure effect, practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Mere Exposure Effect formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in mere exposure effect. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing mere exposure effect.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in mere exposure effect | field-specific |
...
Reading about mere exposure effect invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip mere exposure effect from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under mere exposure effect dynamics.
...
- **Education:** teach mere exposure effect with sandbox labs before equations.
...
- [[paradox-51]] · [[paradox-58]] · [[paradox-64]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bias-2-paper]] — canonical citation anchor

### Potential simulations
- **Mere Exposure Effect Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-51]] — structural analogy
- [[paradox-58]] — structural analogy
