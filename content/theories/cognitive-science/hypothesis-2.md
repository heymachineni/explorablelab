...
slug: "hypothesis-2"
title: "Low × Rule (87)"
summary: "Low × Rule (87): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, low, rule]
scores:
  visual_potential: 7
...
> **One-line essence:** Low × Rule (87) explains how local rules produce global patterns in cognitive science.

## Why this matters

Policymakers, educators, and designers misapply low × rule (87) when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, low × rule (87) describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in low × rule (87). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing low × rule (87).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in low × rule (87) | field-specific |
...
Reading about low × rule (87) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip low × rule (87) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under low × rule (87) dynamics.
...
- **Education:** teach low × rule (87) with sandbox labs before equations.
...
- [[theory-46]] · [[theory-52]] · [[theory-9]]

## Discovery suggestions

### Missing pages to create
- [ ] [[hypothesis-2-paper]] — canonical citation anchor

### Potential simulations
- **Low × Rule (87) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[theory-46]] — structural analogy
- [[theory-52]] — structural analogy
