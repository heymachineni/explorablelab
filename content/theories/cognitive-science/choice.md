...
slug: "choice"
title: "Foot"
summary: "Foot: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, foot]
scores:
  visual_potential: 7
...
> **One-line essence:** Foot links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Foot sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in foot. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing foot.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in foot | field-specific |
...
Reading about foot invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip foot from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under foot dynamics.
...
- **Education:** teach foot with sandbox labs before equations.
...
- [[evolutionary-2]] · [[exponents]] · [[fairness]]

## Discovery suggestions

### Missing pages to create
- [ ] [[choice-paper]] — canonical citation anchor

### Potential simulations
- **Foot Sandbox** — web-simulation — priority: high
