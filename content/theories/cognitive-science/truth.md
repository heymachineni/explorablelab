...
slug: "truth"
title: "Gap"
summary: "Gap: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, gap]
scores:
  visual_potential: 7
...
> **One-line essence:** Gap links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Gap sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in gap. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing gap.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in gap | field-specific |
...
Reading about gap invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip gap from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under gap dynamics.
...
- **Education:** teach gap with sandbox labs before equations.
...
- [[jane-jacobs-corner]] · [[littles-law-queue]] · [[memory-channel]]

## Discovery suggestions

### Missing pages to create
- [ ] [[truth-paper]] — canonical citation anchor

### Potential simulations
- **Gap Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[jane-jacobs-corner]] — structural analogy
- [[littles-law-queue]] — structural analogy
