...
summary: "Spacing Effect: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, spacing, effect]
scores:
  visual_potential: 6
...
> **One-line essence:** Spacing Effect links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Spacing Effect sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
2. Specify update rules or conservation laws governing spacing effect.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in spacing effect | field-specific |
...
Reading about spacing effect invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip spacing effect from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under spacing effect dynamics.
...
- **Education:** teach spacing effect with sandbox labs before equations.
...
- [ ] [[dunning-paper]] — canonical citation anchor

### Potential simulations
- **Spacing Effect Sandbox** — web-simulation — priority: high
