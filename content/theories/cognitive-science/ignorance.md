...
slug: "ignorance"
title: "Naive"
summary: "Naive: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, naive]
scores:
  visual_potential: 7
...
related:
  theories: [law, law-10, law-11]
---

# Naive

> **One-line essence:** Naive explains how local rules produce global patterns in cognitive science.

## Why this matters

Policymakers, educators, and designers misapply naive when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, naive describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in naive. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing naive.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in naive | field-specific |
...
Reading about naive invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip naive from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under naive dynamics.
...
- **Education:** teach naive with sandbox labs before equations.
...
- [[cobra-farm]] · [[compression-poetry]] · [[dunning-valley]]

## Discovery suggestions

### Missing pages to create
- [ ] [[ignorance-paper]] — canonical citation anchor

### Potential simulations
- **Naive Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[cobra-farm]] — structural analogy
