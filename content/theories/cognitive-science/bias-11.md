...
type: "theory"
slug: "bias-11"
title: "Of × Groupthink (69)"
summary: "Of × Groupthink (69): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, groupthink]
scores:
  visual_potential: 8
...
> **One-line essence:** Of × Groupthink (69) is a core framework for reasoning about cognitive science.

## Why this matters

Without grasping of × groupthink (69), practitioners in cognitive science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Of × Groupthink (69) formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in of × groupthink (69). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing of × groupthink (69).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in of × groupthink (69) | field-specific |
...
Reading about of × groupthink (69) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip of × groupthink (69) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under of × groupthink (69) dynamics.
...
- **Education:** teach of × groupthink (69) with sandbox labs before equations.
...
- [[aversion-2]] · [[bandwagon]] · [[bcs]]

## Discovery suggestions

### Missing pages to create
- [ ] [[bias-11-paper]] — canonical citation anchor

### Potential simulations
- **Of × Groupthink (69) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[aversion-2]] — structural analogy
