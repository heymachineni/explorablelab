...
summary: "Framing Effect: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, framing, effect]
scores:
  visual_potential: 8
...
> **One-line essence:** Framing Effect links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Framing Effect sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in framing effect. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing framing effect.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in framing effect | field-specific |
...
Reading about framing effect invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip framing effect from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under framing effect dynamics.
...
- **Education:** teach framing effect with sandbox labs before equations.
...
- [ ] [[effect-5-paper]] — canonical citation anchor

### Potential simulations
- **Framing Effect Sandbox** — web-simulation — priority: high
