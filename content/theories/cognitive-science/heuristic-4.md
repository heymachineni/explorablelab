...
type: "theory"
slug: "heuristic-4"
title: "Sunk Cost Fallacy × Transparency (34)"
summary: "Sunk Cost Fallacy × Transparency (34): understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, sunk, cost, fallacy, transparency]
scores:
  visual_potential: 8
...
related:
  theories: [systems-5, tables, tails]
---

# Sunk Cost Fallacy × Transparency (34)

> **One-line essence:** Sunk Cost Fallacy × Transparency (34) links mechanism, prediction, and intervention in cognitive science.

## Why this matters

Sunk Cost Fallacy × Transparency (34) sits at the fault line between intuition and evidence in cognitive science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in sunk cost fallacy × transparency (34). Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing sunk cost fallacy × transparency (34).
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in sunk cost fallacy × transparency (34) | field-specific |
...
Reading about sunk cost fallacy × transparency (34) invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip sunk cost fallacy × transparency (34) from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under sunk cost fallacy × transparency (34) dynamics.
...
- **Education:** teach sunk cost fallacy × transparency (34) with sandbox labs before equations.
...
- [[kolmogorov]] · [[languages]] · [[law-3]]

## Discovery suggestions

### Missing pages to create
- [ ] [[heuristic-4-paper]] — canonical citation anchor

### Potential simulations
- **Sunk Cost Fallacy × Transparency (34) Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[kolmogorov]] — structural analogy
- [[languages]] — structural analogy
