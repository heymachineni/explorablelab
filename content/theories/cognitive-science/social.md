...
slug: "social"
title: "Realism"
summary: "Realism: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [cognitive-science, realism]
scores:
  visual_potential: 8
...
related:
  theories: [society, solid, somatic]
---

# Realism

> **One-line essence:** Realism explains how local rules produce global patterns in cognitive science.

## Why this matters

Policymakers, educators, and designers misapply realism when they treat averages as mechanisms. Real harm follows: wrong interventions, brittle models, and confident errors.

## Core idea

At its heart, realism describes how agents, variables, or states interact under constraints. The macro pattern is not an extra ingredient—it emerges from repeated micro updates.

## Formal definition

Let **X** denote the primary state variable in realism. Under standard assumptions in cognitive science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing realism.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in realism | field-specific |
...
Reading about realism invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip realism from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under realism dynamics.
...
- **Education:** teach realism with sandbox labs before equations.
...
- [[and]] · [[arbitrage]] · [[attention]]

## Discovery suggestions

### Missing pages to create
- [ ] [[social-paper]] — canonical citation anchor

### Potential simulations
- **Realism Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[and]] — structural analogy
- [[arbitrage]] — structural analogy
