...
slug: "modern-2"
title: "Mimicry"
summary: "Mimicry: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [evolution, mimicry]
scores:
  visual_potential: 7
...
related:
  theories: [neglect-2, network, network-2]
---

# Mimicry

> **One-line essence:** Mimicry links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Mimicry sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in mimicry. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing mimicry.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in mimicry | field-specific |
...
Reading about mimicry invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip mimicry from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under mimicry dynamics.
...
- **Education:** teach mimicry with sandbox labs before equations.
...
- [[paradox-36]] · [[paradox-42]] · [[paradox-49]]

## Discovery suggestions

### Missing pages to create
- [ ] [[modern-2-paper]] — canonical citation anchor

### Potential simulations
- **Mimicry Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-36]] — structural analogy
- [[paradox-42]] — structural analogy
