...
slug: "crispr"
title: "Action"
summary: "Action: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [evolution, action]
scores:
  visual_potential: 6
...
> **One-line essence:** Action links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Action sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in action. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing action.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in action | field-specific |
...
Reading about action invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip action from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under action dynamics.
...
- **Education:** teach action with sandbox labs before equations.
...
- [ ] [[crispr-paper]] — canonical citation anchor

### Potential simulations
- **Action Sandbox** — web-simulation — priority: high
