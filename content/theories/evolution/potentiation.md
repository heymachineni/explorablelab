...
slug: "potentiation"
title: "Holobiont"
summary: "Holobiont: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [evolution, holobiont]
scores:
  visual_potential: 7
...
> **One-line essence:** Holobiont links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Holobiont sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in holobiont | field-specific |
...
Reading about holobiont invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip holobiont from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under holobiont dynamics.
...
- **Education:** teach holobiont with sandbox labs before equations.
...
- [[124-paradox]] · [[130-paradox]] · [[137-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[potentiation-paper]] — canonical citation anchor

### Potential simulations
- **Holobiont Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[124-paradox]] — structural analogy
