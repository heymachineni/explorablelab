...
slug: "punctuated"
title: "Runaway"
summary: "Runaway: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [evolution, runaway]
scores:
  visual_potential: 8
...
> **One-line essence:** Runaway links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Runaway sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in runaway. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing runaway.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in runaway | field-specific |
...
Reading about runaway invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip runaway from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under runaway dynamics.
...
- **Education:** teach runaway with sandbox labs before equations.
...
- [[copenhagen]] · [[crispr]] · [[cultural]]

## Discovery suggestions

### Missing pages to create
- [ ] [[punctuated-paper]] — canonical citation anchor

### Potential simulations
- **Runaway Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[copenhagen]] — structural analogy
- [[crispr]] — structural analogy
