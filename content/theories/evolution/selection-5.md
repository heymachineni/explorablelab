...
slug: "selection-5"
title: "Devo"
summary: "Devo: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Devo links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Devo sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in devo. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing devo.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in devo | field-specific |
...
Reading about devo invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip devo from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under devo dynamics.
...
- **Education:** teach devo with sandbox labs before equations.
...
- [[logical-paradox-147]] · [[logical-paradox-153]] · [[logical-paradox-16]]

## Discovery suggestions

### Missing pages to create
- [ ] [[selection-5-paper]] — canonical citation anchor

### Potential simulations
- **Devo Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[logical-paradox-147]] — structural analogy
- [[logical-paradox-153]] — structural analogy
