...
slug: "system-3"
title: "Herd"
summary: "Herd: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Herd links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Herd sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in herd. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing herd.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in herd | field-specific |
...
Reading about herd invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip herd from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under herd dynamics.
...
- **Education:** teach herd with sandbox labs before equations.
...
- [[market]] · [[maximum]] · [[mechanics-5]]

## Discovery suggestions

### Missing pages to create
- [ ] [[system-3-paper]] — canonical citation anchor

### Potential simulations
- **Herd Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[market]] — structural analogy
- [[maximum]] — structural analogy
