...
slug: "plasticity"
title: "Induction"
summary: "Induction: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [evolution, induction]
scores:
  visual_potential: 8
...
related:
  theories: [labeling, lagrange, lagrangian]
---

# Induction

> **One-line essence:** Induction links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Induction sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in induction. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing induction.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in induction | field-specific |
...
Reading about induction invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip induction from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under induction dynamics.
...
- **Education:** teach induction with sandbox labs before equations.
...
- [ ] [[plasticity-paper]] — canonical citation anchor

### Potential simulations
- **Induction Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[diversity]] — structural analogy
- [[door-2]] — structural analogy
