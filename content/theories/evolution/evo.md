...
slug: "evo"
title: "Arms"
summary: "Arms: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Arms links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Arms sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in arms. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing arms.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in arms | field-specific |
...
Reading about arms invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip arms from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under arms dynamics.
...
- **Education:** teach arms with sandbox labs before equations.
...
- [[organizational]] · [[ostrom-commons-design]] · [[paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[evo-paper]] — canonical citation anchor

### Potential simulations
- **Arms Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[organizational]] — structural analogy
