...
slug: "transport"
title: "Carrying"
summary: "Carrying: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [evolution, carrying]
scores:
  visual_potential: 7
...
related:
  theories: [combinatorics-2, commitment, commons]
---

# Carrying

> **One-line essence:** Carrying links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Carrying sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in carrying. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing carrying.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in carrying | field-specific |
...
Reading about carrying invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip carrying from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under carrying dynamics.
...
- **Education:** teach carrying with sandbox labs before equations.
...
- [[diffusion-2]] · [[diversity]] · [[door-2]]

## Discovery suggestions

### Missing pages to create
- [ ] [[transport-paper]] — canonical citation anchor

### Potential simulations
- **Carrying Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[diffusion-2]] — structural analogy
- [[diversity]] — structural analogy
