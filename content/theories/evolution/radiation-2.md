...
slug: "radiation-2"
title: "Genetic"
summary: "Genetic: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [mcgurk-mouth, median-voter-park, memory-channel]
---

# Genetic

> **One-line essence:** Genetic links mechanism, prediction, and intervention in biology and evolution.

## Why this matters

Genetic sits at the fault line between intuition and evidence in biology and evolution; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in genetic. Under standard assumptions in biology and evolution, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing genetic.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in genetic | field-specific |
...
Reading about genetic invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip genetic from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under genetic dynamics.
...
- **Education:** teach genetic with sandbox labs before equations.
...
- [ ] [[radiation-2-paper]] — canonical citation anchor

### Potential simulations
- **Genetic Sandbox** — web-simulation — priority: high
