...
slug: "raft"
title: "Control"
summary: "Control: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, control]
scores:
  visual_potential: 6
...
> **One-line essence:** Control links mechanism, prediction, and intervention in computer science.

## Why this matters

Control sits at the fault line between intuition and evidence in computer science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in control | field-specific |
...
Reading about control invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip control from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under control dynamics.
...
- **Education:** teach control with sandbox labs before equations.
...
- [[logical-paradox-86]] · [[logical-paradox-92]] · [[logical-paradox-99]]

## Discovery suggestions

### Missing pages to create
- [ ] [[raft-paper]] — canonical citation anchor

### Potential simulations
- **Control Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[logical-paradox-86]] — structural analogy
- [[logical-paradox-92]] — structural analogy
