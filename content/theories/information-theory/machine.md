...
slug: "machine"
title: "Cross"
summary: "Cross: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, cross]
scores:
  visual_potential: 8
...
> **One-line essence:** Cross is a core framework for reasoning about computer science.

## Why this matters

Without grasping cross, practitioners in computer science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Cross formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in cross. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing cross.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in cross | field-specific |
...
Reading about cross invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip cross from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under cross dynamics.
...
- **Education:** teach cross with sandbox labs before equations.
...
- [[paradox-207]] · [[paradox-213]] · [[paradox-22]]

## Discovery suggestions

### Missing pages to create
- [ ] [[machine-paper]] — canonical citation anchor

### Potential simulations
- **Cross Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-207]] — structural analogy
- [[paradox-213]] — structural analogy
