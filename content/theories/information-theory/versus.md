...
slug: "versus"
title: "Computability"
summary: "Computability: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
related:
  theories: [theory-38, theory-39, theory-4]
---

# Computability

> **One-line essence:** Computability is a core framework for reasoning about computer science.

## Why this matters

Without grasping computability, practitioners in computer science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Computability formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in computability. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing computability.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in computability | field-specific |
...
Reading about computability invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip computability from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under computability dynamics.
...
- **Education:** teach computability with sandbox labs before equations.
...
- [[group-6]] · [[hamiltonian]] · [[hazard]]

## Discovery suggestions

### Missing pages to create
- [ ] [[versus-paper]] — canonical citation anchor

### Potential simulations
- **Computability Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[group-6]] — structural analogy
- [[hamiltonian]] — structural analogy
