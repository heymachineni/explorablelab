...
slug: "turing"
title: "Church"
summary: "Church: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, church]
scores:
  visual_potential: 8
...
related:
  theories: [door-2, drift, dual]
---

# Church

> **One-line essence:** Church is a core framework for reasoning about computer science.

## Why this matters

Without grasping church, practitioners in computer science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Church formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in church. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing church.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in church | field-specific |
...
Reading about church invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip church from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under church dynamics.
...
- **Education:** teach church with sandbox labs before equations.
...
- [[mcgurk-mouth]] · [[mullers-ratchet]] · [[p-hacking-lab]]

## Discovery suggestions

### Missing pages to create
- [ ] [[turing-paper]] — canonical citation anchor

### Potential simulations
- **Church Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[mcgurk-mouth]] — structural analogy
- [[mullers-ratchet]] — structural analogy
