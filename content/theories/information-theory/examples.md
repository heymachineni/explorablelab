...
slug: "examples"
title: "Work"
summary: "Work: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, work]
scores:
  visual_potential: 8
...
related:
  theories: [biogeography, biology, biology-2]
---

# Work

> **One-line essence:** Work links mechanism, prediction, and intervention in computer science.

## Why this matters

Work sits at the fault line between intuition and evidence in computer science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in work. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing work.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in work | field-specific |
...
Reading about work invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip work from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under work dynamics.
...
- **Education:** teach work with sandbox labs before equations.
...
- [ ] [[examples-paper]] — canonical citation anchor

### Potential simulations
- **Work Sandbox** — web-simulation — priority: high
