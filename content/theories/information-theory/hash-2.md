...
slug: "hash-2"
title: "Scheduling"
summary: "Scheduling: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
...
> **One-line essence:** Scheduling links mechanism, prediction, and intervention in computer science.

## Why this matters

Scheduling sits at the fault line between intuition and evidence in computer science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in scheduling. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing scheduling.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in scheduling | field-specific |
...
Reading about scheduling invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip scheduling from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under scheduling dynamics.
...
- **Education:** teach scheduling with sandbox labs before equations.
...
- [[sorites-paradox]] · [[survivorship-bias-paradox]] · [[tragedy-paradox]]

## Discovery suggestions

### Missing pages to create
- [ ] [[hash-2-paper]] — canonical citation anchor

### Potential simulations
- **Scheduling Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[sorites-paradox]] — structural analogy
