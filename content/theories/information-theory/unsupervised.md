...
slug: "unsupervised"
title: "Fairness"
summary: "Fairness: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, fairness]
scores:
  visual_potential: 8
...
related:
  theories: [social-8, social-choice, society]
---

# Fairness

> **One-line essence:** Fairness links mechanism, prediction, and intervention in computer science.

## Why this matters

Fairness sits at the fault line between intuition and evidence in computer science; misunderstanding it propagates through textbooks, dashboards, and public debate.
...
Let **X** denote the primary state variable in fairness. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing fairness.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in fairness | field-specific |
...
Reading about fairness invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip fairness from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under fairness dynamics.
...
- **Education:** teach fairness with sandbox labs before equations.
...
- [[logical-paradox-66]] · [[logical-paradox-72]] · [[logical-paradox-79]]

## Discovery suggestions

### Missing pages to create
- [ ] [[unsupervised-paper]] — canonical citation anchor

### Potential simulations
- **Fairness Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[logical-paradox-66]] — structural analogy
- [[logical-paradox-72]] — structural analogy
