...
related:
  theories: [compromise, computability, computer]
---

# Adversarial

> **One-line essence:** Adversarial is a core framework for reasoning about computer science.

## Why this matters

Without grasping adversarial, practitioners in computer science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Adversarial formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.
...
- [ ] [[learning-4-paper]] — canonical citation anchor
