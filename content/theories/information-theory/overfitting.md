...
slug: "overfitting"
title: "Flp"
summary: "Flp: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, flp]
scores:
  visual_potential: 8
...
related:
  theories: [sandpile-avalanche, sapir-whorf-lens, signaling-peacock]
---

# Flp

> **One-line essence:** Flp is a core framework for reasoning about computer science.

## Why this matters

Without grasping flp, practitioners in computer science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Flp formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in flp. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing flp.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in flp | field-specific |
...
Reading about flp invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip flp from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under flp dynamics.
...
- **Education:** teach flp with sandbox labs before equations.
...
- [[paradox-45]] · [[paradox-51]] · [[paradox-58]]

## Discovery suggestions

### Missing pages to create
- [ ] [[overfitting-paper]] — canonical citation anchor

### Potential simulations
- **Flp Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[paradox-45]] — structural analogy
