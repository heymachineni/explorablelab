...
slug: "stake"
title: "Affordances"
summary: "Affordances: understanding improves when learners manipulate the mechanism directly."
status: "mature"
created: "2026-06-26"
updated: "2026-06-26"
confidence: "medium"
tags: [computer-science, affordances]
scores:
  visual_potential: 8
...
> **One-line essence:** Affordances is a core framework for reasoning about computer science.

## Why this matters

Without grasping affordances, practitioners in computer science overfit anecdotes to theory and under-specify the variables that actually drive outcomes.

## Core idea

Affordances formalizes a relationship that practitioners already gesture at informally: which quantities matter, which feedback loops dominate, and where predictions break.

## Formal definition

Let **X** denote the primary state variable in affordances. Under standard assumptions in computer science, the relationship is written compactly as a mapping from initial conditions and parameters to observables. Exact notation varies by subfield; the explorable version should expose parameters, not hide them behind prose.

## Mechanism

1. Identify the units of analysis (agents, particles, beliefs, prices).
2. Specify update rules or conservation laws governing affordances.
...
|-----------|---------|---------------|
| Primary rate | Controls speed of adjustment in affordances | field-specific |
...
Reading about affordances invites hindsight bias: every outcome feels inevitable once labeled. An explorable lets users **set parameters, perturb initial conditions, and watch failure modes**—the only route to calibrated intuition.

## Surprising implications

- Small parameter shifts can flip affordances from stable to explosive regimes.
- Mean outcomes can mislead when variance and tail risk dominate welfare.
- Interventions optimized on short horizons often reverse under affordances dynamics.
...
- **Education:** teach affordances with sandbox labs before equations.
...
- [[streetlight-search]] · [[trophic-cascade-kelp]] · [[zeno-arrow]]

## Discovery suggestions

### Missing pages to create
- [ ] [[stake-paper]] — canonical citation anchor

### Potential simulations
- **Affordances Sandbox** — web-simulation — priority: high

### Cross-disciplinary links
- [[streetlight-search]] — structural analogy
